...
import { SidecarSkeleton } from 'components/utils/SkeletonLoaders.tsx'

export function GlobalServiceSidecar({
  globalService,
  loading,
}: {
  ...
  if (!globalService && !loading) return null
        ...
        <>
          <Sidecar heading="Source">
            <SidecarItem heading="Type">
              <Chip>
                {globalService?.service ? 'Seed service' : 'Template'}
              </Chip>
            </SidecarItem>
