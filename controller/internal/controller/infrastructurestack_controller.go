...
func (r *InfrastructureStackReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	utils.SyncCredentialsInfo(stack, stack.SetCondition, nc, err)
	if err != nil {
...
func (r *InfrastructureStackReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.NamespaceCredentials{}, utils.HandleCredentialsChange(r.Client, new(v1alpha1.InfrastructureStackList))). // Reconcile objects if namespaced credentials change.
