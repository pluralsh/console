...
func (r *ManagedNamespaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	utils.SyncCredentialsInfo(managedNamespace, managedNamespace.SetCondition, nc, err)
	if err != nil {
...
func (r *ManagedNamespaceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.NamespaceCredentials{}, utils.OnCredentialsChange(r.Client, new(v1alpha1.ManagedNamespaceList))). // Reconcile objects on credentials change.
