...
func (r *ClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.NamespaceCredentials{}, utils.HandleCredentialsChange(r.Client, new(v1alpha1.ClusterList))). // Reconcile objects if namespaced credentials change.
...
func (r *ClusterReconciler) Reconcile(ctx context.Context, req reconcile.Request) (_ reconcile.Result, reterr error) {
	...
	utils.SyncCredentialsInfo(cluster, cluster.SetCondition, nc, err)
	if err != nil {
