...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrAutomationStatus) DeepCopyInto(out *PrAutomationStatus) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrAutomationStatus.
func (in *PrAutomationStatus) DeepCopy() *PrAutomationStatus {
	if in == nil {
		return nil
	}
	out := new(PrAutomationStatus)
	in.DeepCopyInto(out)
	return out
}
