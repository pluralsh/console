...
func (in *NotificationRouterSpec) DeepCopyInto(out *NotificationRouterSpec) {
	*out = *in
	...
	if in.Filters != nil {
		...
		*out = make([]RouterFilterAttributes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouterFilterAttributes) DeepCopyInto(out *RouterFilterAttributes) {
	*out = *in
	if in.Regex != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouterFilterAttributes.
func (in *RouterFilterAttributes) DeepCopy() *RouterFilterAttributes {
	if in == nil {
		return nil
	}
	out := new(RouterFilterAttributes)
	in.DeepCopyInto(out)
	return out
}
