...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StepStage) DeepCopyInto(out *StepStage) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StepStage.
func (in *StepStage) DeepCopy() *StepStage {
	if in == nil {
		return nil
	}
	out := new(StepStage)
