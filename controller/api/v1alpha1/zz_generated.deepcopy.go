...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterTargetAttributes) DeepCopyInto(out *ClusterTargetAttributes) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterTargetAttributes.
func (in *ClusterTargetAttributes) DeepCopy() *ClusterTargetAttributes {
	if in == nil {
		return nil
	}
	out := new(ClusterTargetAttributes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedNamespaceSpec) DeepCopyInto(out *ManagedNamespaceSpec) {
	*out = *in
	...
	if in.Service != nil {
		...
		*out = new(ServiceTemplateAttributes)
		(*in).DeepCopyInto(*out)
	}
	if in.Target != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceTemplateAttributes) DeepCopyInto(out *ServiceTemplateAttributes) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceTemplateAttributes.
func (in *ServiceTemplateAttributes) DeepCopy() *ServiceTemplateAttributes {
	if in == nil {
		return nil
	}
	out := new(ServiceTemplateAttributes)
