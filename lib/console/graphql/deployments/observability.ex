defmodule Console.GraphQl.Deployments.Observability do
  ...
  input_object :monitor_query_attributes do
    field :log, :monitor_log_query_attributes,
      description: "Log query used when the monitor type is log‑based"

    field :metrics, :monitor_metrics_query_attributes,
      description: "Metrics query used when the monitor type is metrics-based"
  end

  @desc "Log query configuration for a monitor"
  input_object :monitor_log_query_attributes do
    field :tool, :string,
      description: "Named workbench logs tool; when omitted, uses the native Plural logs provider"
    ...
    field :options, :monitor_log_options_attributes,
      description: "Provider-specific log query options"
  end

  @desc "Metrics query configuration for a monitor"
  input_object :monitor_metrics_query_attributes do
    field :tool, :string,
      description: "Named workbench metrics tool; when omitted, uses the native Plural metrics provider"

    field :query, non_null(:string),
      description: "Metrics query string passed through to the underlying metrics provider"

    field :step, :string,
      description: "Metrics query step (for example 5m)"

    field :duration, :string,
      description: "Lookback duration for the metrics query (for example 1h)"

    field :options, :monitor_metrics_options_attributes,
      description: "Provider-specific metrics query options"
  end

  input_object :monitor_log_options_attributes do
    field :azure, :monitor_log_azure_options_attributes
  end

  input_object :monitor_log_azure_options_attributes do
    field :resource_id, :string
  end

  input_object :monitor_metrics_options_attributes do
    field :azure, :monitor_metrics_azure_options_attributes
  end

  input_object :monitor_metrics_azure_options_attributes do
    field :resource_id, :string
  ...
  object :monitor_log_query do
    field :tool, :string,
      description: "Named workbench logs tool, or null for the native Plural logs provider"
    ...
    field :options, :monitor_log_options
  end

  @desc "Metrics-level query parameters for a monitor"
  object :monitor_metrics_query do
    field :tool, :string,
      description: "Named workbench metrics tool, or null for the native Plural metrics provider"

    field :query, non_null(:string)
    field :step, :string
    field :duration, :string
    field :options, :monitor_metrics_options
  end

  object :monitor_log_options do
    field :azure, :monitor_log_azure_options
  end

  object :monitor_log_azure_options do
    field :resource_id, :string
  end

  object :monitor_metrics_options do
    field :azure, :monitor_metrics_azure_options
  end

  object :monitor_metrics_azure_options do
    field :resource_id, :string
    field :metrics_namespace, :string
    field :aggregation, :string
    field :filter, :string
  ...
  object :monitor_query do
    field :log, :monitor_log_query,
      description: "Log query configuration used by this monitor"

    field :metrics, :monitor_metrics_query,
      description: "Metrics query configuration used by this monitor"
  end
  ...
  object :alert do
    ...
    field :workbench_job, :workbench_job,
      resolve: dataloader(Deployments),
      description: "The workbench job this alert was associated with"
