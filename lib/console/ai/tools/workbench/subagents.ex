defmodule Console.AI.Tools.Workbench.Subagents do
  ...
  defp subagent_description(:coding, _), do: "Invoke a coding subagent to analyze or modify code, generating a pull request.  This subagent will use either direct repository urls or container image urls to determine where to make code changes, so include either or both to guide it appropriately, alongside a clear spec of the change or analysis needed."
  ...
  defp subagent_description(:search, _), do: "Invoke a web search subagent to search the public web for information.  Useful to find documentation, public pricing information, and anything else that's not specific to deployed infrastructure."
