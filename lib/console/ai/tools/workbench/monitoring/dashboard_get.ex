defmodule Console.AI.Tools.Workbench.Monitoring.DashboardGet do
  ...
  def name(_), do: "workbench_dashboard"
  def json_schema(_), do: @json_schema

  def description(_),
    do: "Show a dashboard from this workbench, including its graph layouts, variable inputs, and observability data sources."
  ...
  def implement(%__MODULE__{job: job, dashboard_id: id}), do: Monitoring.get_dashboard(job, id)
end
