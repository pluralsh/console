defmodule Console.AI.Tools.Workbench.Infrastructure.CloudTables do
  ...
  def description(_),
    do: "Shows the available tables for querying a cloud account using sql. Can also fuzzy search for certain tables using the table parameter to save tokens."
  ...
  def implement(_), do: {:error, "cloud tables tool is missing a cloud connection"}
end
