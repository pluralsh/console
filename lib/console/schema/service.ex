defmodule Console.Schema.Service do
  ...
  defmodule Source do
    ...
    embedded_schema do
      ...
      embeds_one :git, Console.Schema.Service.Git, on_replace: :update
    end
  ...
  defmodule Renderer do
    use Piazza.Ecto.Schema
    alias Console.Schema.Service.RendererType
  ...
  schema "services" do
    ...
    embeds_one :kustomize, Kustomize, on_replace: :update do
      ...
      field :envsubst, :boolean, default: false
    end
  ...
  def kustomize_changeset(model, attrs \\ %{}) do
    model
    |> cast(attrs, ~w(path enable_helm envsubst)a)
