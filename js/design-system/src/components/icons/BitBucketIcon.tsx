...
/** Atlassian Bitbucket brand blues (full-color mode). */
const BITBUCKET_BLUE = '#2684FF'
const BITBUCKET_BLUE_DEEP = '#0052CC'

export default createIcon(({ size, color, fullColor }) => {
  const mainFill = fullColor ? BITBUCKET_BLUE : color
  const gradientEnd = fullColor ? BITBUCKET_BLUE_DEEP : color
