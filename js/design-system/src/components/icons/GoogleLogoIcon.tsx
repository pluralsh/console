...
export default createIcon(({ size, color, fullColor }) => (
  ...
  >
    <g transform="matrix(.66666667 0 0 .66666667 18.006 -26.159333)">
      <path
      ...
      />
      <path
        d="m-21.484 53.529c-.25-.72-.38-1.49-.38-2.29s.14-1.57.38-2.29v-3.09h-3.98c-.82 1.62-1.29 3.44-1.29 5.38s.47 3.76 1.29 5.38z"
