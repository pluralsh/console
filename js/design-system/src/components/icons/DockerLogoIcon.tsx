...
export default createIcon(({ size, color, fullColor }) => (
  ...
  >
    <path
      fill={fullColor ? DOCKER_OCEAN_BLUE : color}
      d={DOCKER_MARK_PATH}
    />
  </svg>
))
