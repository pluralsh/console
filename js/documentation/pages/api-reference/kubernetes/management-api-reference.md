...
| `mcpServers` _boolean_ | McpServers enables access to the "Manage MCP servers" action from the flows page when set to true.<br />This allows personas to navigate to MCP server settings directly from flows. |  | Optional: \{\} <br /> |
