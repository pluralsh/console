...
export { default as FastReverseIcon } from './components/icons/FastReverseIcon'
...
export { default as GitMerge } from './components/icons/GitMergeIcon'
export { default as GitPull } from './components/icons/GitPullIcon'
