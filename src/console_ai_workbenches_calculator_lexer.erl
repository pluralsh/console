-file("/Users/michaelguarino/.asdf/installs/erlang/27.3.2/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-module(console_ai_workbenches_calculator_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/console_ai_workbenches_calculator_lexer.xrl", 21).
...
-file("/Users/michaelguarino/.asdf/installs/erlang/27.3.2/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
-file("src/console_ai_workbenches_calculator_lexer.erl", 347).
yystate() -> 16.
...
yystate(17, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(17, Ics, Line+1, 1, Tlen+1, 0, Tlen);
...
yystate(16, [40|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [32|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [13|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [9|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(13, Ics, Line, Col, Tlen, _, _) ->
    {7,Tlen,Ics,Line,Col};
yystate(12, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(10, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(12, [69|Ics], Line, Col, Tlen, _, _) ->
    yystate(10, Ics, Line, Col, Tlen+1, 10, Tlen);
...
yystate(12, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(12, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {10,Tlen,Ics,Line,Col,12};
...
yystate(0, [45|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(0, [43|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
...
-file("src/console_ai_workbenches_calculator_lexer.xrl", 7).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 8).
yyaction_1(TokenLine) ->
     { token, { plus, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { minus, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { times, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { pow, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 12).
yyaction_5(TokenLine) ->
     { token, { divide, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 13).
yyaction_6(TokenLine) ->
     { token, { lparen, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 14).
yyaction_7(TokenLine) ->
     { token, { rparen, TokenLine } } .

-compile({inline,yyaction_8/2}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 15).
yyaction_8(TokenChars, TokenLine) ->
     { token, { number, TokenLine, to_float (TokenChars) } } .

-compile({inline,yyaction_9/2}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 16).
yyaction_9(TokenChars, TokenLine) ->
     { token, { number, TokenLine, to_float (TokenChars) } } .

-compile({inline,yyaction_10/2}).
-file("src/console_ai_workbenches_calculator_lexer.xrl", 17).
yyaction_10(TokenChars, TokenLine) ->
     { token, { number, TokenLine, to_float (TokenChars) } } .
-file("/Users/michaelguarino/.asdf/installs/erlang/27.3.2/lib/parsetools-2.6/include/leexinc.hrl", 344).
