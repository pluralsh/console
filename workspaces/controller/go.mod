module github.com/pluralsh/console/controller
...
require (
	...
	github.com/pluralsh/console/client v0.0.0-00010101000000-000000000000
...
replace (
	github.com/pluralsh/console/client => ../client
