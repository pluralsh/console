...
config :console, :consumers, [
  ...
  Console.Deployments.PubSub.Binding,
...
config :console, Console.Cron.Scheduler,
  ...
  jobs: [
    ...
    {"30 */4 * * *",   {Console.Deployments.Cron, :prune_migrations, []}},
