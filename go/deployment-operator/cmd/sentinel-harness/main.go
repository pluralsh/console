...
import (
	...
	"github.com/pluralsh/console/go/deployment-operator/cmd/sentinel-harness/args"
	...
	"github.com/pluralsh/console/go/deployment-operator/pkg/sentinel-harness/controller"
	"github.com/pluralsh/console/go/deployment-operator/pkg/sentinel-harness/environment"
)
