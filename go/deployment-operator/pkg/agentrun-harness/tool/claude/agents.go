...
const analysisAgent = `{
  "analysis": {
    ...
    "tools": ["Read", "Grep", "Glob", "Bash", "mcp__plural__updateAgentRunAnalysis", "mcp__plural__getPRState", "mcp__plural__getCILogs"]
  }
}`
...
const autonomousAgent = `{
  "autonomous": {
    ...
    "tools": ["Read", "Write", "Edit", "MultiEdit", "Bash", "Grep", "Glob", "WebFetch", "mcp__plural__agentPullRequest", "mcp__plural__createBranch", "mcp__plural__fetchAgentRunTodos", "mcp__plural__updateAgentRunTodos", "mcp__plural__createCommit", "mcp__plural__getPRState", "mcp__plural__getCILogs", "mcp__plural__reactToComment"]
  }
}`
