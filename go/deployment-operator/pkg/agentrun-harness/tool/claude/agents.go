...
const analysisAgent = `{
  "analysis": {
    ...
    "tools": ["Read", "Grep", "Glob", "Bash", "mcp__plural__updateAgentRunAnalysis", "mcp__plural__getPRState", "mcp__plural__getCILogs", "mcp__plural__downloadServiceManifests"]
  }
}`
...
const babysitAgent = `{
  "babysit": {
    ...
    "tools": ["Read", "Write", "Edit", "MultiEdit", "Bash", "Grep", "Glob", "WebFetch", "mcp__plural__updateAgentRunAnalysis", "mcp__plural__createCommit", "mcp__plural__fetchAgentRunTodos", "mcp__plural__updateAgentRunTodos", "mcp__plural__getPRState", "mcp__plural__getCILogs", "mcp__plural__downloadServiceManifests", "mcp__plural__reactToComment"]
  }
}`
