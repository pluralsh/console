...
import (
	...
	common2 "github.com/pluralsh/console/go/deployment-operator/pkg/controller/common"
	...
	manis "github.com/pluralsh/console/go/deployment-operator/pkg/manifests"
	...
	"github.com/pluralsh/console/go/deployment-operator/pkg/streamline/applier"
...
type ServiceReconciler struct {
	...
	store                                                                store.Store
	manifestTTL, workqueueBaseDelay, workqueueMaxDelay, waveDeQueueDelay time.Duration
