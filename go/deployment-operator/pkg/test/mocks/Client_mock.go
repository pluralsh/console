...
import (
	...
	v1alpha1 "github.com/pluralsh/console/go/deployment-operator/api/v1alpha1"
...
// AgentPrReview provides a mock function with given fields: ctx, runID, attrs
func (_m *ClientMock) AgentPrReview(ctx context.Context, runID string, attrs goclient.AgentPrReviewAttributes) (*goclient.PullRequestFragment, error) {
	ret := _m.Called(ctx, runID, attrs)

	if len(ret) == 0 {
		panic("no return value specified for AgentPrReview")
	}

	var r0 *goclient.PullRequestFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, goclient.AgentPrReviewAttributes) (*goclient.PullRequestFragment, error)); ok {
		return rf(ctx, runID, attrs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, goclient.AgentPrReviewAttributes) *goclient.PullRequestFragment); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, goclient.AgentPrReviewAttributes) error); ok {
...
// ClientMock_AgentPrReview_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AgentPrReview'
type ClientMock_AgentPrReview_Call struct {
	*mock.Call
}

// AgentPrReview is a helper method to define mock.On call
//   - ctx context.Context
//   - runID string
//   - attrs goclient.AgentPrReviewAttributes
func (_e *ClientMock_Expecter) AgentPrReview(ctx interface{}, runID interface{}, attrs interface{}) *ClientMock_AgentPrReview_Call {
	return &ClientMock_AgentPrReview_Call{Call: _e.mock.On("AgentPrReview", ctx, runID, attrs)}
}

func (_c *ClientMock_AgentPrReview_Call) Run(run func(ctx context.Context, runID string, attrs goclient.AgentPrReviewAttributes)) *ClientMock_AgentPrReview_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(goclient.AgentPrReviewAttributes))
	})
	return _c
}

func (_c *ClientMock_AgentPrReview_Call) Return(_a0 *goclient.PullRequestFragment, _a1 error) *ClientMock_AgentPrReview_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientMock_AgentPrReview_Call) RunAndReturn(run func(context.Context, string, goclient.AgentPrReviewAttributes) (*goclient.PullRequestFragment, error)) *ClientMock_AgentPrReview_Call {
	_c.Call.Return(run)
	return _c
}
...
// CreateAgentRunUpload provides a mock function with given fields: ctx, runID, attrs
func (_m *ClientMock) CreateAgentRunUpload(ctx context.Context, runID string, attrs goclient.AgentRunUploadAttributes) (*goclient.AgentRunUploadFragment, error) {
	ret := _m.Called(ctx, runID, attrs)

	if len(ret) == 0 {
		panic("no return value specified for CreateAgentRunUpload")
	}

	var r0 *goclient.AgentRunUploadFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, goclient.AgentRunUploadAttributes) (*goclient.AgentRunUploadFragment, error)); ok {
		return rf(ctx, runID, attrs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, goclient.AgentRunUploadAttributes) *goclient.AgentRunUploadFragment); ok {
		r0 = rf(ctx, runID, attrs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*goclient.AgentRunUploadFragment)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, goclient.AgentRunUploadAttributes) error); ok {
		r1 = rf(ctx, runID, attrs)
	} else {
		r1 = ret.Error(1)
	}
...
// ClientMock_CreateAgentRunUpload_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateAgentRunUpload'
type ClientMock_CreateAgentRunUpload_Call struct {
	*mock.Call
}

// CreateAgentRunUpload is a helper method to define mock.On call
//   - ctx context.Context
//   - runID string
//   - attrs goclient.AgentRunUploadAttributes
func (_e *ClientMock_Expecter) CreateAgentRunUpload(ctx interface{}, runID interface{}, attrs interface{}) *ClientMock_CreateAgentRunUpload_Call {
	return &ClientMock_CreateAgentRunUpload_Call{Call: _e.mock.On("CreateAgentRunUpload", ctx, runID, attrs)}
}

func (_c *ClientMock_CreateAgentRunUpload_Call) Run(run func(ctx context.Context, runID string, attrs goclient.AgentRunUploadAttributes)) *ClientMock_CreateAgentRunUpload_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(goclient.AgentRunUploadAttributes))
	})
	return _c
}

func (_c *ClientMock_CreateAgentRunUpload_Call) Return(_a0 *goclient.AgentRunUploadFragment, _a1 error) *ClientMock_CreateAgentRunUpload_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientMock_CreateAgentRunUpload_Call) RunAndReturn(run func(context.Context, string, goclient.AgentRunUploadAttributes) (*goclient.AgentRunUploadFragment, error)) *ClientMock_CreateAgentRunUpload_Call {
	_c.Call.Return(run)
	return _c
}
