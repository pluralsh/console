...
func (x *RunPythonInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RunPythonInput) ProtoMessage() {}

func (x *RunPythonInput) ProtoReflect() protoreflect.Message {
	mi := &file_toolquery_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RunPythonInput.ProtoReflect.Descriptor instead.
func (*RunPythonInput) Descriptor() ([]byte, []int) {
	return file_toolquery_proto_rawDescGZIP(), []int{44}
}

func (x *RunPythonInput) GetScript() string {
	if x != nil {
		return x.Script
	}
	return ""
...
func (x *RunPythonInput) GetInputJson() string {
	if x != nil {
		return x.InputJson
	}
	return ""
...
func (x *RunPythonOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RunPythonOutput) ProtoMessage() {}

func (x *RunPythonOutput) ProtoReflect() protoreflect.Message {
	mi := &file_toolquery_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RunPythonOutput.ProtoReflect.Descriptor instead.
func (*RunPythonOutput) Descriptor() ([]byte, []int) {
	return file_toolquery_proto_rawDescGZIP(), []int{45}
}

func (x *RunPythonOutput) GetResultJson() string {
	if x != nil {
		return x.ResultJson
	}
	return ""
...
func (x *RunPythonOutput) GetStdout() string {
	if x != nil {
		return x.Stdout
	}
	return ""
...
const file_toolquery_proto_rawDesc = "" +
	...
	"\x06RunLua\x12\x16.toolquery.RunLuaInput\x1a\x17.toolquery.RunLuaOutput\"\x00\x12D\n" +
	"\tRunPython\x12\x19.toolquery.RunPythonInput\x1a\x1a.toolquery.RunPythonOutput\"\x00BEZCgithub.com/pluralsh/console/go/cloud-query/internal/proto/toolqueryb\x06proto3"
...
var file_toolquery_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_toolquery_proto_goTypes = []any{
	...
	(*RunPythonInput)(nil),                 // 44: toolquery.RunPythonInput
	(*RunPythonOutput)(nil),                // 45: toolquery.RunPythonOutput
	nil,                                    // 46: toolquery.MetricPoint.LabelsEntry
	nil,                                    // 47: toolquery.LogEntry.LabelsEntry
	nil,                                    // 48: toolquery.TraceSpan.TagsEntry
	(*timestamppb.Timestamp)(nil),          // 49: google.protobuf.Timestamp
	(*cloudquery.Connection)(nil),          // 50: cloudquery.Connection
}
var file_toolquery_proto_depIdxs = []int32{
	0,  // 0: toolquery.ToolConnection.elastic:type_name -> toolquery.ElasticConnection
	2,  // 1: toolquery.ToolConnection.datadog:type_name -> toolquery.DatadogConnection
	3,  // 2: toolquery.ToolConnection.prometheus:type_name -> toolquery.PrometheusConnection
	4,  // 3: toolquery.ToolConnection.loki:type_name -> toolquery.LokiConnection
	5,  // 4: toolquery.ToolConnection.tempo:type_name -> toolquery.TempoConnection
	7,  // 5: toolquery.ToolConnection.splunk:type_name -> toolquery.SplunkConnection
	8,  // 6: toolquery.ToolConnection.dynatrace:type_name -> toolquery.DynatraceConnection
	9,  // 7: toolquery.ToolConnection.cloudwatch:type_name -> toolquery.CloudwatchConnection
	...
	49, // 11: toolquery.TimeRange.start:type_name -> google.protobuf.Timestamp
	49, // 12: toolquery.TimeRange.end:type_name -> google.protobuf.Timestamp
	...
	15, // 16: toolquery.MetricsOptions.azure:type_name -> toolquery.AzureMetricsOptions
	11, // 17: toolquery.LogsQueryInput.connection:type_name -> toolquery.ToolConnection
	12, // 18: toolquery.LogsQueryInput.range:type_name -> toolquery.TimeRange
	16, // 19: toolquery.LogsQueryInput.facets:type_name -> toolquery.LogsQueryFacet
	18, // 20: toolquery.LogsQueryInput.options:type_name -> toolquery.LogsOptions
	19, // 21: toolquery.LogsOptions.azure:type_name -> toolquery.AzureLogsOptions
	11, // 22: toolquery.TracesQueryInput.connection:type_name -> toolquery.ToolConnection
	12, // 23: toolquery.TracesQueryInput.range:type_name -> toolquery.TimeRange
	...
	49, // 27: toolquery.MetricPoint.timestamp:type_name -> google.protobuf.Timestamp
	46, // 28: toolquery.MetricPoint.labels:type_name -> toolquery.MetricPoint.LabelsEntry
	...
	49, // 38: toolquery.LogEntry.timestamp:type_name -> google.protobuf.Timestamp
	47, // 39: toolquery.LogEntry.labels:type_name -> toolquery.LogEntry.LabelsEntry
	36, // 40: toolquery.LogsQueryOutput.logs:type_name -> toolquery.LogEntry
	49, // 41: toolquery.TraceSpan.start:type_name -> google.protobuf.Timestamp
	49, // 42: toolquery.TraceSpan.end:type_name -> google.protobuf.Timestamp
	48, // 43: toolquery.TraceSpan.tags:type_name -> toolquery.TraceSpan.TagsEntry
	38, // 44: toolquery.TracesQueryOutput.spans:type_name -> toolquery.TraceSpan
	50, // 45: toolquery.InvokeLambdaInput.connection:type_name -> cloudquery.Connection
	...
	44, // 53: toolquery.ToolQuery.RunPython:input_type -> toolquery.RunPythonInput
	25, // 54: toolquery.ToolQuery.Metrics:output_type -> toolquery.MetricsQueryOutput
	30, // 55: toolquery.ToolQuery.MetricsSearch:output_type -> toolquery.MetricsSearchOutput
	35, // 56: toolquery.ToolQuery.MetricsLabelSearch:output_type -> toolquery.MetricsLabelSearchOutput
	37, // 57: toolquery.ToolQuery.Logs:output_type -> toolquery.LogsQueryOutput
	39, // 58: toolquery.ToolQuery.Traces:output_type -> toolquery.TracesQueryOutput
	41, // 59: toolquery.ToolQuery.InvokeLambda:output_type -> toolquery.InvokeLambdaOutput
	43, // 60: toolquery.ToolQuery.RunLua:output_type -> toolquery.RunLuaOutput
	45, // 61: toolquery.ToolQuery.RunPython:output_type -> toolquery.RunPythonOutput
