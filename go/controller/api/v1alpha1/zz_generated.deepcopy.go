...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiffNormalizerAttributes) DeepCopyInto(out *DiffNormalizerAttributes) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiffNormalizerAttributes.
func (in *DiffNormalizerAttributes) DeepCopy() *DiffNormalizerAttributes {
	if in == nil {
		return nil
	}
	out := new(DiffNormalizerAttributes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SyncConfigAttributes) DeepCopyInto(out *SyncConfigAttributes) {
	*out = *in
	...
	if in.DiffNormalizers != nil {
		...
		*out = make([]DiffNormalizerAttributes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
