...
func (in *PersonaFlows) DeepCopyInto(out *PersonaFlows) {
	*out = *in
	if in.HidePermissions != nil {
		in, out := &in.HidePermissions, &out.HidePermissions
		*out = new(bool)
		**out = **in
	}
	if in.HideStartWorkbenchJob != nil {
		in, out := &in.HideStartWorkbenchJob, &out.HideStartWorkbenchJob
		*out = new(bool)
		**out = **in
	}
