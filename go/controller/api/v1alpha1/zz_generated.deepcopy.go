...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradePlanCalloutCallout) DeepCopyInto(out *UpgradePlanCalloutCallout) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradePlanCalloutCallout.
func (in *UpgradePlanCalloutCallout) DeepCopy() *UpgradePlanCalloutCallout {
	if in == nil {
		return nil
	}
	out := new(UpgradePlanCalloutCallout)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpgradePlanCalloutSpec) DeepCopyInto(out *UpgradePlanCalloutSpec) {
	*out = *in
	...
	if in.Callouts != nil {
		...
		*out = make([]UpgradePlanCalloutCallout, len(*in))
		copy(*out, *in)
	}
	in.Context.DeepCopyInto(&out.Context)
	if in.Reconciliation != nil {
