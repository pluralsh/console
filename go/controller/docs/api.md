...
| `usePodIdentity` _boolean_ | UsePodIdentity enables IRSA/Workload Identity for AWS authentication instead of static credentials.<br />When enabled, the controller will use the default AWS credential chain which supports IRSA. |  | Optional: \{\} <br /> |
