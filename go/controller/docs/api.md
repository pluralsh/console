...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `cd` _boolean_ | CD enables access to the continuous deployment navigation item when set to true.<br />This is the entry point for clusters, services, pipelines, and other deployment<br />management views. Use the Deployments configuration to control the individual<br />views within it. |  | Optional: \{\} <br /> |
...
| `ai` _boolean_ | AI enables access to the Plural AI navigation item when set to true.<br />This includes AI insights, chat threads, and other AI-driven investigation tools.<br />Use the AI configuration to control individual AI capabilities within it. |  | Optional: \{\} <br /> |
