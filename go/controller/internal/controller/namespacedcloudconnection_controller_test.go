...
var _ = Describe("CloudConnection Controller", Ordered, func() {
	Context("when reconciling resource", func() {
		...
		BeforeAll(func() {
			...
			Expect(common.MaybeCreate(k8sClient, &v1alpha1.NamespacedCloudConnection{
				ObjectMeta: metav1.ObjectMeta{
					Name:      connectionName,
					Namespace: namespace,
				},
			...
			}, func(p *v1alpha1.NamespacedCloudConnection) {
		...
		AfterAll(func() {
			...
			connection := &v1alpha1.NamespacedCloudConnection{}
			...
			readonlyProvider := &v1alpha1.NamespacedCloudConnection{}
		...
		It("should successfully reconcile connection", func() {
			...
			controllerReconciler := &controller.NamespacedCloudConnectionReconciler{
				Client:         k8sClient,
		...
		It("should successfully reconcile and update previously created connection", func() {
			Expect(common.MaybePatch(k8sClient, &v1alpha1.NamespacedCloudConnection{
