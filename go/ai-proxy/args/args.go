...
var (
	...
	argBedrockMantlePrefixes  = pflag.StringSlice("bedrock-mantle-model-prefixes", helpers.GetPluralEnvSlice(envBedrockMantlePrefixes, []string{"gpt-5.6", "gpt-6"}), "OpenAI model prefixes routed to Amazon Bedrock Mantle.")
