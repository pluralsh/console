...
// CreateIndex provides a mock function with given fields: index, definition
func (_m *ElasticsearchClientMock) CreateIndex(index string, definition runtime.RawExtension) (*esapi.Response, error) {
	ret := _m.Called(index, definition)
...
// ElasticsearchClientMock_CreateIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateIndex'
type ElasticsearchClientMock_CreateIndex_Call struct {
	*mock.Call
}
...
func (_e *ElasticsearchClientMock_Expecter) CreateIndex(index interface{}, definition interface{}) *ElasticsearchClientMock_CreateIndex_Call {
	return &ElasticsearchClientMock_CreateIndex_Call{Call: _e.mock.On("CreateIndex", index, definition)}
}

func (_c *ElasticsearchClientMock_CreateIndex_Call) Run(run func(index string, definition runtime.RawExtension)) *ElasticsearchClientMock_CreateIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ElasticsearchClientMock_CreateIndex_Call) Return(_a0 *esapi.Response, _a1 error) *ElasticsearchClientMock_CreateIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ElasticsearchClientMock_CreateIndex_Call) RunAndReturn(run func(string, runtime.RawExtension) (*esapi.Response, error)) *ElasticsearchClientMock_CreateIndex_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteIndex provides a mock function with given fields: ctx, index
func (_m *ElasticsearchClientMock) DeleteIndex(ctx context.Context, index string) (*esapi.Response, error) {
...
// ElasticsearchClientMock_DeleteIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteIndex'
type ElasticsearchClientMock_DeleteIndex_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - index string
func (_e *ElasticsearchClientMock_Expecter) DeleteIndex(ctx interface{}, index interface{}) *ElasticsearchClientMock_DeleteIndex_Call {
	return &ElasticsearchClientMock_DeleteIndex_Call{Call: _e.mock.On("DeleteIndex", ctx, index)}
}

func (_c *ElasticsearchClientMock_DeleteIndex_Call) Run(run func(ctx context.Context, index string)) *ElasticsearchClientMock_DeleteIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ElasticsearchClientMock_DeleteIndex_Call) Return(_a0 *esapi.Response, _a1 error) *ElasticsearchClientMock_DeleteIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ElasticsearchClientMock_DeleteIndex_Call) RunAndReturn(run func(context.Context, string) (*esapi.Response, error)) *ElasticsearchClientMock_DeleteIndex_Call {
	_c.Call.Return(run)
	return _c
}
...
// ExistsIndex provides a mock function with given fields: ctx, index
func (_m *ElasticsearchClientMock) ExistsIndex(ctx context.Context, index string) (*esapi.Response, error) {
	ret := _m.Called(ctx, index)

	if len(ret) == 0 {
		panic("no return value specified for ExistsIndex")
	}
...
// ElasticsearchClientMock_ExistsIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ExistsIndex'
type ElasticsearchClientMock_ExistsIndex_Call struct {
	*mock.Call
}

// ExistsIndex is a helper method to define mock.On call
//   - ctx context.Context
//   - index string
func (_e *ElasticsearchClientMock_Expecter) ExistsIndex(ctx interface{}, index interface{}) *ElasticsearchClientMock_ExistsIndex_Call {
	return &ElasticsearchClientMock_ExistsIndex_Call{Call: _e.mock.On("ExistsIndex", ctx, index)}
}

func (_c *ElasticsearchClientMock_ExistsIndex_Call) Run(run func(ctx context.Context, index string)) *ElasticsearchClientMock_ExistsIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *ElasticsearchClientMock_ExistsIndex_Call) Return(_a0 *esapi.Response, _a1 error) *ElasticsearchClientMock_ExistsIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ElasticsearchClientMock_ExistsIndex_Call) RunAndReturn(run func(context.Context, string) (*esapi.Response, error)) *ElasticsearchClientMock_ExistsIndex_Call {
	_c.Call.Return(run)
	return _c
}
