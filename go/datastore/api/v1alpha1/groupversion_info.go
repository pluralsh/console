...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "dbs.plural.sh", Version: "v1alpha1"}

	// SchemeBuilder is used to add go types to the GroupVersionKind scheme
	SchemeBuilder = &schemeBuilder{GroupVersion: GroupVersion, SchemeBuilder: runtime.NewSchemeBuilder()}
