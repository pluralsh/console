...
"github.com/Yamashou/gqlgenc/clientv2")
	...
	type  ClusterBackupFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Cluster *ClusterBackupFragment_Cluster "json:\"cluster,omitempty\" graphql:\"cluster\""; GarbageCollected *bool "json:\"garbageCollected,omitempty\" graphql:\"garbageCollected\""}
...
return t.GarbageCollected
	...
	type  ClusterRestoreFragment struct{ID string "json:\"id\" graphql:\"id\""; Status RestoreStatus "json:\"status\" graphql:\"status\""; Backup *ClusterBackupFragment "json:\"backup,omitempty\" graphql:\"backup\""}
...
return t.Backup
	...
	type  BootstrapTokenBase struct{ID string "json:\"id\" graphql:\"id\""; Token string "json:\"token\" graphql:\"token\""}
...
func (t *ClusterFragment) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &ClusterFragment{}
}
return t.Metadata
...
return t.Project
	...
	type  ClusterTags struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Credentials
	...
	type  NodePoolFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; MinSize int64 "json:\"minSize\" graphql:\"minSize\""; MaxSize int64 "json:\"maxSize\" graphql:\"maxSize\""; InstanceType string "json:\"instanceType\" graphql:\"instanceType\""; Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Taints []*NodePoolTaintFragment "json:\"taints,omitempty\" graphql:\"taints\""}
...
func (t *NodePoolFragment) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &NodePoolFragment{}
}
return t.Labels
...
return t.Taints
	...
	type  NodePoolTaintFragment struct{Key string "json:\"key\" graphql:\"key\""; Value string "json:\"value\" graphql:\"value\""; Effect string "json:\"effect\" graphql:\"effect\""}
...
return t.Effect
	...
	type  ClusterStatusFragment struct{Conditions []*ClusterConditionFragment "json:\"conditions,omitempty\" graphql:\"conditions\""}
...
return t.Conditions
	...
	type  ClusterConditionFragment struct{Status *string "json:\"status,omitempty\" graphql:\"status\""; Type *string "json:\"type,omitempty\" graphql:\"type\""; Message *string "json:\"message,omitempty\" graphql:\"message\""; Reason *string "json:\"reason,omitempty\" graphql:\"reason\""}
...
func (t *ClusterRegistrationFragment) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &ClusterRegistrationFragment{}
}
return t.Metadata
...
return t.Project
	...
	type  ClusterIsoImageFragment struct{ID string "json:\"id\" graphql:\"id\""; Image string "json:\"image\" graphql:\"image\""; Project *TinyProjectFragment "json:\"project,omitempty\" graphql:\"project\""; Registry string "json:\"registry\" graphql:\"registry\""; User *string "json:\"user,omitempty\" graphql:\"user\""}
...
return t.User
	...
	type  PipelineGateIDsEdgeFragment struct{Node *PipelineGateIDsEdgeFragment_Node_ "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  PipelineGateEdgeFragment struct{Node *PipelineGateFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  PipelineGateFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Type GateType "json:\"type\" graphql:\"type\""; State GateState "json:\"state\" graphql:\"state\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""; Spec *GateSpecFragment "json:\"spec,omitempty\" graphql:\"spec\""; Status *GateStatusFragment "json:\"status,omitempty\" graphql:\"status\""}
...
return t.Status
	...
	type  GateSpecFragment struct{Job *JobSpecFragment "json:\"job,omitempty\" graphql:\"job\""}
...
return t.Job
	...
	type  GateStatusFragment struct{JobRef *JobReferenceFragment "json:\"jobRef,omitempty\" graphql:\"jobRef\""}
...
func (t *JobSpecFragment) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &JobSpecFragment{}
}
return t.Labels
}
func (t *JobSpecFragment) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &JobSpecFragment{}
}
...
return t.Requests
	...
	type  ContainerResourcesFragment struct{Requests *ResourceRequestFragment "json:\"requests,omitempty\" graphql:\"requests\""; Limits *ResourceRequestFragment "json:\"limits,omitempty\" graphql:\"limits\""}
...
return t.Limits
	...
	type  ResourceRequestFragment struct{CPU *string "json:\"cpu,omitempty\" graphql:\"cpu\""; Memory *string "json:\"memory,omitempty\" graphql:\"memory\""}
...
return t.Memory
	...
	type  JobReferenceFragment struct{Name string "json:\"name\" graphql:\"name\""; Namespace string "json:\"namespace\" graphql:\"namespace\""}
...
return t.Namespace
	...
	type  ContainerSpecFragment struct{Image string "json:\"image\" graphql:\"image\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Env []*ContainerSpecFragment_Env "json:\"env,omitempty\" graphql:\"env\""; EnvFrom []*ContainerSpecFragment_EnvFrom "json:\"envFrom,omitempty\" graphql:\"envFrom\""}
...
return t.Path
	...
	type  ServiceDeploymentBaseFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Namespace string "json:\"namespace\" graphql:\"namespace\""; Version string "json:\"version\" graphql:\"version\""; Status ServiceDeploymentStatus "json:\"status\" graphql:\"status\""; Kustomize *KustomizeFragment "json:\"kustomize,omitempty\" graphql:\"kustomize\""; Git *GitRefFragment "json:\"git,omitempty\" graphql:\"git\""; Helm *HelmSpecFragment "json:\"helm,omitempty\" graphql:\"helm\""; Repository *GitRepositoryFragment "json:\"repository,omitempty\" graphql:\"repository\""}
...
return t.Repository
	...
	type  ServiceDeploymentIDFragment struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type  ServiceContextFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Configuration map[string]any "json:\"configuration,omitempty\" graphql:\"configuration\""}
...
func (t *ServiceContextFragment) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &ServiceContextFragment{}
}
return t.Configuration
	...
	type  ComponentContentFragment struct{ID string "json:\"id\" graphql:\"id\""; Live *string "json:\"live,omitempty\" graphql:\"live\""; Desired *string "json:\"desired,omitempty\" graphql:\"desired\""}
...
return t.Configuration
	...
	type  ErrorFragment struct{Source string "json:\"source\" graphql:\"source\""; Message string "json:\"message\" graphql:\"message\""}
...
return t.Message
	...
	type  RevisionFragment struct{ID string "json:\"id\" graphql:\"id\""; Sha *string "json:\"sha,omitempty\" graphql:\"sha\""; Git *RevisionFragment_Git "json:\"git,omitempty\" graphql:\"git\""}
...
return t.Git
	...
	type  PolicyBindingFragment struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Group *GroupFragment "json:\"group,omitempty\" graphql:\"group\""; User *UserFragment "json:\"user,omitempty\" graphql:\"user\""}
...
return t.User
	...
	type  UserFragment struct{Name string "json:\"name\" graphql:\"name\""; ID string "json:\"id\" graphql:\"id\""; Email string "json:\"email\" graphql:\"email\""}
...
return t.Email
	...
	type  GroupFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Description *string "json:\"description,omitempty\" graphql:\"description\""}
...
return t.Description
	...
	type  GroupMemberFragment struct{ID string "json:\"id\" graphql:\"id\""; User *GroupMemberFragment_User "json:\"user,omitempty\" graphql:\"user\""; Group *GroupMemberFragment_Group "json:\"group,omitempty\" graphql:\"group\""}
...
return t.Group
	...
	type  GitRefFragment struct{Folder string "json:\"folder\" graphql:\"folder\""; Ref string "json:\"ref\" graphql:\"ref\""}
...
return t.Ref
	...
	type  HelmSpecFragment struct{ValuesFiles []*string "json:\"valuesFiles,omitempty\" graphql:\"valuesFiles\""}
...
func (t *BaseClusterFragment) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &BaseClusterFragment{}
}
return t.Metadata
...
return t.Repository
	...
	type  GitRepositoryEdgeFragment struct{Node *GitRepositoryFragment "json:\"node,omitempty\" graphql:\"node\""; Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""}
...
return t.Ai
	...
	type  ClusterEdgeFragment struct{Node *ClusterFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  ServiceDeploymentEdgeFragment struct{Node *ServiceDeploymentBaseFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  ServiceDeploymentEdgeFragmentForAgent struct{Node *ServiceDeploymentForAgent "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  ServiceDeploymentIDEdgeFragment struct{Node *ServiceDeploymentIDFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  GlobalServiceFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Distro *ClusterDistro "json:\"distro,omitempty\" graphql:\"distro\""; Provider *GlobalServiceFragment_Provider "json:\"provider,omitempty\" graphql:\"provider\""; Service *GlobalServiceFragment_Service "json:\"service,omitempty\" graphql:\"service\""; Tags []*ClusterTags "json:\"tags,omitempty\" graphql:\"tags\""; Project *TinyProjectFragment "json:\"project,omitempty\" graphql:\"project\""}
...
return t.Project
	...
	type  ScmConnectionFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; APIURL *string "json:\"apiUrl,omitempty\" graphql:\"apiUrl\""; BaseURL *string "json:\"baseUrl,omitempty\" graphql:\"baseUrl\""; Type ScmType "json:\"type\" graphql:\"type\""; Username *string "json:\"username,omitempty\" graphql:\"username\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""}
...
return t.UpdatedAt
	...
	type  PrAutomationFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Title string "json:\"title\" graphql:\"title\""; Addon *string "json:\"addon,omitempty\" graphql:\"addon\""; Message string "json:\"message\" graphql:\"message\""; Identifier *string "json:\"identifier,omitempty\" graphql:\"identifier\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""}
...
return t.UpdatedAt
	...
	type  PageInfoFragment struct{HasNextPage bool "json:\"hasNextPage\" graphql:\"hasNextPage\""; EndCursor *string "json:\"endCursor,omitempty\" graphql:\"endCursor\""}
...
return t.EndCursor
	...
	type  PipelineContextFragment struct{ID string "json:\"id\" graphql:\"id\""; Context map[string]any "json:\"context\" graphql:\"context\""}
...
func (t *PipelineContextFragment) GetContext() map[string]*types.Alias----{
if t == nil {
 t = &PipelineContextFragment{}
}
return t.Context
	...
	type  PullRequestFragment struct{ID string "json:\"id\" graphql:\"id\""; Status *PrStatus "json:\"status,omitempty\" graphql:\"status\""; URL string "json:\"url\" graphql:\"url\""; Title *string "json:\"title,omitempty\" graphql:\"title\""; Creator *string "json:\"creator,omitempty\" graphql:\"creator\""}
...
return t.Creator
	...
	type  SyncConfigFragment struct{CreateNamespace *bool "json:\"createNamespace,omitempty\" graphql:\"createNamespace\""; NamespaceMetadata *NamespaceMetadataFragment "json:\"namespaceMetadata,omitempty\" graphql:\"namespaceMetadata\""}
...
return t.NamespaceMetadata
	...
	type  NamespaceMetadataFragment struct{Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Annotations map[string]any "json:\"annotations,omitempty\" graphql:\"annotations\""}

    func (t *NamespaceMetadataFragment) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &NamespaceMetadataFragment{}
}
return t.Labels
}
func (t *NamespaceMetadataFragment) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &NamespaceMetadataFragment{}
}
return t.Annotations
	...
	type  ClusterTargetFragment struct{Tags map[string]any "json:\"tags,omitempty\" graphql:\"tags\""; Distro *ClusterDistro "json:\"distro,omitempty\" graphql:\"distro\""}

    func (t *ClusterTargetFragment) GetTags() map[string]*types.Alias----{
if t == nil {
...
return t.Distro
	...
	type  AISettingsFragment struct{Enabled *bool "json:\"enabled,omitempty\" graphql:\"enabled\""; Provider *AiProvider "json:\"provider,omitempty\" graphql:\"provider\""; Openai *AISettingsFragment_Openai "json:\"openai,omitempty\" graphql:\"openai\""; Anthropic *AISettingsFragment_Anthropic "json:\"anthropic,omitempty\" graphql:\"anthropic\""}
...
return t.Anthropic
	...
	type  ManagedNamespaceEdgeFragment struct{Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""; Node *ManagedNamespaceMinimalFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  ManagedNamespaceMinimalFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Description *string "json:\"description,omitempty\" graphql:\"description\""}
...
func (t *ManagedNamespaceFragment) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &ManagedNamespaceFragment{}
}
return t.Labels
}
func (t *ManagedNamespaceFragment) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &ManagedNamespaceFragment{}
}
return t.Annotations
...
return t.SyncConfig
	...
	type  NotificationRouterFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Sinks []*NotificationSinkFragment "json:\"sinks,omitempty\" graphql:\"sinks\""; Events []string "json:\"events,omitempty\" graphql:\"events\""}
...
return t.Events
	...
	type  NotificationSinkEdgeFragment struct{Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""; Node *NotificationSinkFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  NotificationSinkFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Type SinkType "json:\"type\" graphql:\"type\""; Configuration SinkConfigurationFragment "json:\"configuration\" graphql:\"configuration\""; NotificationBindings []*PolicyBindingFragment "json:\"notificationBindings,omitempty\" graphql:\"notificationBindings\""}
...
return t.NotificationBindings
	...
	type  SinkConfigurationFragment struct{ID string "json:\"id\" graphql:\"id\""; Slack *URLSinkConfigurationFragment "json:\"slack,omitempty\" graphql:\"slack\""; Teams *URLSinkConfigurationFragment "json:\"teams,omitempty\" graphql:\"teams\""}
...
return t.Teams
	...
	type  URLSinkConfigurationFragment struct{URL string "json:\"url\" graphql:\"url\""}
...
return t.RedirectUris
	...
	type  ObservabilityProviderFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Type ObservabilityProviderType "json:\"type\" graphql:\"type\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""}
...
return t.UpdatedAt
	...
	type  ObserverActionFragment struct{Type ObserverActionType "json:\"type\" graphql:\"type\""; Configuration ObserverActionConfigurationFragment "json:\"configuration\" graphql:\"configuration\""}
...
return &t.Configuration
	...
	type  ObserverActionConfigurationFragment struct{Pr *ObserverPrActionFragment "json:\"pr,omitempty\" graphql:\"pr\""; Pipeline *ObserverPipelineActionFragment "json:\"pipeline,omitempty\" graphql:\"pipeline\""}
...
return t.Pipeline
	...
	type  ObserverPipelineActionFragment struct{PipelineID string "json:\"pipelineId\" graphql:\"pipelineId\""; Context map[string]any "json:\"context\" graphql:\"context\""}
...
func (t *ObserverPipelineActionFragment) GetContext() map[string]*types.Alias----{
if t == nil {
 t = &ObserverPipelineActionFragment{}
}
return t.Context
	...
	type  ObserverPrActionFragment struct{AutomationID string "json:\"automationId\" graphql:\"automationId\""; Repository *string "json:\"repository,omitempty\" graphql:\"repository\""; BranchTemplate *string "json:\"branchTemplate,omitempty\" graphql:\"branchTemplate\""; Context string "json:\"context\" graphql:\"context\""}
...
return t.Context
	...
	type  ObserverTargetFragment struct{Helm *ObserverHelmRepoFragment "json:\"helm,omitempty\" graphql:\"helm\""; Oci *ObserverOciRepoFragment "json:\"oci,omitempty\" graphql:\"oci\""}
...
return t.Oci
	...
	type  ObserverOciRepoFragment struct{URL string "json:\"url\" graphql:\"url\""; Provider *HelmAuthProvider "json:\"provider,omitempty\" graphql:\"provider\""}
...
return t.Provider
	...
	type  ObserverHelmRepoFragment struct{URL string "json:\"url\" graphql:\"url\""; Chart string "json:\"chart\" graphql:\"chart\""; Provider *HelmAuthProvider "json:\"provider,omitempty\" graphql:\"provider\""}
...
return t.Provider
	...
	type  PolicyConstraintConnectionFragment struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*PolicyConstraintEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type  PolicyConstraintEdgeFragment struct{Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""; Node *PolicyConstraintFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  PolicyConstraintFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Description *string "json:\"description,omitempty\" graphql:\"description\""; Recommendation *string "json:\"recommendation,omitempty\" graphql:\"recommendation\""; ViolationCount *int64 "json:\"violationCount,omitempty\" graphql:\"violationCount\""; Ref *ConstraintRefFragment "json:\"ref,omitempty\" graphql:\"ref\""; Violations []*ViolationFragment "json:\"violations,omitempty\" graphql:\"violations\""}
...
return t.Violations
	...
	type  ConstraintRefFragment struct{Kind string "json:\"kind\" graphql:\"kind\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type  ViolationFragment struct{ID string "json:\"id\" graphql:\"id\""; Group *string "json:\"group,omitempty\" graphql:\"group\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Kind *string "json:\"kind,omitempty\" graphql:\"kind\""; Namespace *string "json:\"namespace,omitempty\" graphql:\"namespace\""; Name *string "json:\"name,omitempty\" graphql:\"name\""; Message *string "json:\"message,omitempty\" graphql:\"message\""}
...
return t.Message
	...
	type  ViolationStatisticFragment struct{Value *string "json:\"value,omitempty\" graphql:\"value\""; Violations *int64 "json:\"violations,omitempty\" graphql:\"violations\""; Count *int64 "json:\"count,omitempty\" graphql:\"count\""}
...
return t.Count
	...
	type  PipelineFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Stages []*PipelineStageFragment "json:\"stages,omitempty\" graphql:\"stages\""; Edges []*PipelineStageEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""; Project *TinyProjectFragment "json:\"project,omitempty\" graphql:\"project\""}
...
return t.Project
	...
	type  PipelineFragmentMinimal struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type  PipelineFragmentID struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type  PipelineStageFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Services []*PipelineStageFragment_Services "json:\"services,omitempty\" graphql:\"services\""}
...
return &t.To
	...
	type  PipelineEdgeFragment struct{Node *PipelineFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  ProjectFragment struct{ID string "json:\"id\" graphql:\"id\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""; Name string "json:\"name\" graphql:\"name\""; Default *bool "json:\"default,omitempty\" graphql:\"default\""; Description *string "json:\"description,omitempty\" graphql:\"description\""; ReadBindings []*PolicyBindingFragment "json:\"readBindings,omitempty\" graphql:\"readBindings\""; WriteBindings []*PolicyBindingFragment "json:\"writeBindings,omitempty\" graphql:\"writeBindings\""}
...
return t.WriteBindings
	...
	type  TinyProjectFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Default *bool "json:\"default,omitempty\" graphql:\"default\""}
...
return t.Default
	...
	type  ProviderCredentialFragment struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Namespace string "json:\"namespace\" graphql:\"namespace\""; Kind string "json:\"kind\" graphql:\"kind\""}
...
return t.Kind
	...
	type  InfrastructureStackEdgeFragment struct{Node *InfrastructureStackFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  StackRunEdgeFragment struct{Node *StackRunFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  MinimalStackRunEdgeFragment struct{Node *StackRunMinimalFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  StackRunIDEdgeFragment struct{Node *StackRunIDFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type  InfrastructureStackIDFragment struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type  InfrastructureStackStatusFragment struct{Status StackStatus "json:\"status\" graphql:\"status\""}
...
func (t *InfrastructureStackFragment) GetVariables() map[string]*types.Alias----{
if t == nil {
 t = &InfrastructureStackFragment{}
}
return t.Variables
	...
	type  StackRunIDFragment struct{ID string "json:\"id\" graphql:\"id\""}
...
func (t *StackRunFragment) GetVariables() map[string]*types.Alias----{
if t == nil {
 t = &StackRunFragment{}
}
return t.Variables
...
return t.Approver
	...
	type  StackRunMinimalFragment struct{ID string "json:\"id\" graphql:\"id\""; Type StackType "json:\"type\" graphql:\"type\""; Status StackStatus "json:\"status\" graphql:\"status\""; Approval *bool "json:\"approval,omitempty\" graphql:\"approval\""; ApprovedAt *string "json:\"approvedAt,omitempty\" graphql:\"approvedAt\""; Tarball string "json:\"tarball\" graphql:\"tarball\""; Workdir *string "json:\"workdir,omitempty\" graphql:\"workdir\""; ManageState *bool "json:\"manageState,omitempty\" graphql:\"manageState\""; JobSpec *JobSpecFragment "json:\"jobSpec,omitempty\" graphql:\"jobSpec\""; Configuration StackConfigurationFragment "json:\"configuration\" graphql:\"configuration\""}
...
return &t.Configuration
	...
	type  StackRunBaseFragment struct{ID string "json:\"id\" graphql:\"id\""; Type StackType "json:\"type\" graphql:\"type\""; Status StackStatus "json:\"status\" graphql:\"status\""; Approval *bool "json:\"approval,omitempty\" graphql:\"approval\""; ApprovedAt *string "json:\"approvedAt,omitempty\" graphql:\"approvedAt\""; Tarball string "json:\"tarball\" graphql:\"tarball\""; Workdir *string "json:\"workdir,omitempty\" graphql:\"workdir\""; ManageState *bool "json:\"manageState,omitempty\" graphql:\"manageState\""; StateUrls *StackRunBaseFragment_StateUrls "json:\"stateUrls,omitempty\" graphql:\"stateUrls\""; PluralCreds *StackRunBaseFragment_PluralCreds "json:\"pluralCreds,omitempty\" graphql:\"pluralCreds\""; Actor *UserFragment "json:\"actor,omitempty\" graphql:\"actor\""; Stack *InfrastructureStackFragment "json:\"stack,omitempty\" graphql:\"stack\""; State *StackStateFragment "json:\"state,omitempty\" graphql:\"state\""; Steps []*RunStepFragment "json:\"steps,omitempty\" graphql:\"steps\""; Files []*StackFileFragment "json:\"files,omitempty\" graphql:\"files\""; Git GitRefFragment "json:\"git\" graphql:\"git\""; Repository *GitRepositoryFragment "json:\"repository,omitempty\" graphql:\"repository\""; JobSpec *JobSpecFragment "json:\"jobSpec,omitempty\" graphql:\"jobSpec\""; Configuration StackConfigurationFragment "json:\"configuration\" graphql:\"configuration\""; Environment []*StackEnvironmentFragment "json:\"environment,omitempty\" graphql:\"environment\""; Output []*StackOutputFragment "json:\"output,omitempty\" graphql:\"output\""; Errors []*ServiceErrorFragment "json:\"errors,omitempty\" graphql:\"errors\""; Variables map[string]any "json:\"variables,omitempty\" graphql:\"variables\""}
...
func (t *StackRunBaseFragment) GetVariables() map[string]*types.Alias----{
if t == nil {
 t = &StackRunBaseFragment{}
}
return t.Variables
	...
	type  ServiceErrorFragment struct{Source string "json:\"source\" graphql:\"source\""; Message string "json:\"message\" graphql:\"message\""}
...
return t.Message
	...
	type  StackOutputFragment struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Secret
	...
	type  StackStateFragment struct{ID string "json:\"id\" graphql:\"id\""; Plan *string "json:\"plan,omitempty\" graphql:\"plan\""; State []*StackStateResourceFragment "json:\"state,omitempty\" graphql:\"state\""}
...
func (t *StackStateResourceFragment) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &StackStateResourceFragment{}
}
return t.Configuration
...
return t.Links
	...
	type  StackEnvironmentFragment struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Secret
	...
	type  StackFileFragment struct{Path string "json:\"path\" graphql:\"path\""; Content string "json:\"content\" graphql:\"content\""}
...
return t.Index
	...
	type  StackConfigurationFragment struct{Image *string "json:\"image,omitempty\" graphql:\"image\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Tag *string "json:\"tag,omitempty\" graphql:\"tag\""; Hooks []*StackHookFragment "json:\"hooks,omitempty\" graphql:\"hooks\""}
...
return t.Hooks
	...
	type  StackHookFragment struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return t.Configuration
	...
	type  StackCommandFragment struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Dir *string "json:\"dir,omitempty\" graphql:\"dir\""}
...
return t.Dir
	...
	type  PrConfigurationFragment struct{Type ConfigurationType "json:\"type\" graphql:\"type\""; Name string "json:\"name\" graphql:\"name\""; Default *string "json:\"default,omitempty\" graphql:\"default\""; Documentation *string "json:\"documentation,omitempty\" graphql:\"documentation\""; Longform *string "json:\"longform,omitempty\" graphql:\"longform\""; Placeholder *string "json:\"placeholder,omitempty\" graphql:\"placeholder\""; Optional *bool "json:\"optional,omitempty\" graphql:\"optional\""; Condition *PrConfigurationConditionFragment "json:\"condition,omitempty\" graphql:\"condition\""}
...
return t.Condition
	...
	type  PrConfigurationConditionFragment struct{Operation Operation "json:\"operation\" graphql:\"operation\""; Field string "json:\"field\" graphql:\"field\""; Value *string "json:\"value,omitempty\" graphql:\"value\""}
...
return t.Steps
	...
	type  AccessTokenFragment struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type ClusterRestoreFragment_Backup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.Content
	...
	type ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
func (t *ServiceDeploymentForAgent_Cluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentForAgent_Cluster{}
}
return t.Metadata
...
return t.Distro
	...
	type ServiceDeploymentForAgent_Kustomize struct{Path string "json:\"path\" graphql:\"path\""}
...
return t.Path
	...
	type ServiceDeploymentForAgent_Helm struct{Release *string "json:\"release,omitempty\" graphql:\"release\""; ValuesFiles []*string "json:\"valuesFiles,omitempty\" graphql:\"valuesFiles\""; IgnoreHooks *bool "json:\"ignoreHooks,omitempty\" graphql:\"ignoreHooks\""}
...
return t.IgnoreHooks
	...
	type ServiceDeploymentForAgent_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ServiceDeploymentForAgent_Contexts struct{Name string "json:\"name\" graphql:\"name\""; Configuration map[string]any "json:\"configuration,omitempty\" graphql:\"configuration\""}
...
func (t *ServiceDeploymentForAgent_Contexts) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentForAgent_Contexts{}
}
return t.Configuration
	...
	type ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata struct{Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Annotations map[string]any "json:\"annotations,omitempty\" graphql:\"annotations\""}

    func (t *ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Labels
}
func (t *ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Annotations
...
return t.NamespaceMetadata
	...
	type ServiceDeploymentForAgent_Revision struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type ServiceDeploymentForAgent_Imports_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type ServiceDeploymentForAgent_Imports_Outputs struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Secret
	...
	type ServiceDeploymentForAgent_Imports struct{ID string "json:\"id\" graphql:\"id\""; Stack *ServiceDeploymentForAgent_Imports_Stack "json:\"stack,omitempty\" graphql:\"stack\""; Outputs []*ServiceDeploymentForAgent_Imports_Outputs "json:\"outputs,omitempty\" graphql:\"outputs\""}
...
return t.Outputs
	...
	type PipelineGateIDsEdgeFragment_Node_ struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type PipelineGateEdgeFragment_Node_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type PipelineGateEdgeFragment_Node_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Content
	...
	type ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Folder
	...
	type ServiceDeploymentExtended_ServiceDeploymentFragment_Components struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Group *string "json:\"group,omitempty\" graphql:\"group\""; Kind string "json:\"kind\" graphql:\"kind\""; Namespace *string "json:\"namespace,omitempty\" graphql:\"namespace\""; State *ComponentState "json:\"state,omitempty\" graphql:\"state\""; Synced bool "json:\"synced\" graphql:\"synced\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Content *ComponentContentFragment "json:\"content,omitempty\" graphql:\"content\""}
...
return t.Content
	...
	type ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Folder
	...
	type GroupMemberFragment_User struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GroupMemberFragment_Group struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeploymentSettingsFragment_Ai_AISettingsFragment_Openai struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type DeploymentSettingsFragment_Ai_AISettingsFragment_Anthropic struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Content
	...
	type ClusterEdgeFragment_Node_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
func (t *ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Cluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Cluster{}
}
return t.Metadata
...
return t.Distro
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Kustomize struct{Path string "json:\"path\" graphql:\"path\""}
...
return t.Path
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Helm struct{Release *string "json:\"release,omitempty\" graphql:\"release\""; ValuesFiles []*string "json:\"valuesFiles,omitempty\" graphql:\"valuesFiles\""; IgnoreHooks *bool "json:\"ignoreHooks,omitempty\" graphql:\"ignoreHooks\""}
...
return t.IgnoreHooks
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts struct{Name string "json:\"name\" graphql:\"name\""; Configuration map[string]any "json:\"configuration,omitempty\" graphql:\"configuration\""}
...
func (t *ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts{}
}
return t.Configuration
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata struct{Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Annotations map[string]any "json:\"annotations,omitempty\" graphql:\"annotations\""}

    func (t *ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Labels
}
func (t *ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Annotations
...
return t.NamespaceMetadata
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Revision struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Imports_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Imports_Outputs struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Outputs
	...
	type GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type AISettingsFragment_Openai struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type AISettingsFragment_Anthropic struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type PipelineFragment_Stages_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Secrets
	...
	type PipelineFragment_Stages_PipelineStageFragment_Services struct{Service *ServiceDeploymentBaseFragment "json:\"service,omitempty\" graphql:\"service\""; Criteria *PipelineFragment_Stages_PipelineStageFragment_Services_Criteria "json:\"criteria,omitempty\" graphql:\"criteria\""}
...
return t.Criteria
	...
	type PipelineFragment_Edges_PipelineStageEdgeFragment_From_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type PipelineFragment_Edges_PipelineStageEdgeFragment_To_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Secrets
	...
	type PipelineStageFragment_Services struct{Service *ServiceDeploymentBaseFragment "json:\"service,omitempty\" graphql:\"service\""; Criteria *PipelineStageFragment_Services_Criteria "json:\"criteria,omitempty\" graphql:\"criteria\""}
...
return t.Criteria
	...
	type PipelineStageEdgeFragment_From_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Secrets
	...
	type PipelineStageEdgeFragment_From_PipelineStageFragment_Services struct{Service *ServiceDeploymentBaseFragment "json:\"service,omitempty\" graphql:\"service\""; Criteria *PipelineStageEdgeFragment_From_PipelineStageFragment_Services_Criteria "json:\"criteria,omitempty\" graphql:\"criteria\""}
...
return t.Criteria
	...
	type PipelineStageEdgeFragment_To_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Secrets
	...
	type PipelineStageEdgeFragment_To_PipelineStageFragment_Services struct{Service *ServiceDeploymentBaseFragment "json:\"service,omitempty\" graphql:\"service\""; Criteria *PipelineStageEdgeFragment_To_PipelineStageFragment_Services_Criteria "json:\"criteria,omitempty\" graphql:\"criteria\""}
...
return t.Criteria
	...
	type PipelineEdgeFragment_Node_PipelineFragment_Stages_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type PipelineEdgeFragment_Node_PipelineFragment_Edges_PipelineStageEdgeFragment_From_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type PipelineEdgeFragment_Node_PipelineFragment_Edges_PipelineStageEdgeFragment_To_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type InfrastructureStackEdgeFragment_Node_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type InfrastructureStackEdgeFragment_Node_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_StateUrls struct{Terraform *StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type MinimalStackRunEdgeFragment_Node_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type MinimalStackRunEdgeFragment_Node_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunFragment_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type StackRunFragment_StackRunBaseFragment_StateUrls struct{Terraform *StackRunFragment_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type StackRunFragment_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type StackRunBaseFragment_StateUrls struct{Terraform *StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type CustomStackRunFragment_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return &t.AfterStage
	...
	type StackDefinitionFragment_Configuration struct{Image *string "json:\"image,omitempty\" graphql:\"image\""; Tag *string "json:\"tag,omitempty\" graphql:\"tag\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Hooks []*StackDefinitionFragment_Configuration_Hooks "json:\"hooks,omitempty\" graphql:\"hooks\""}
...
return t.Hooks
	...
	type StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type CreateClusterBackup_CreateClusterBackup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GetClusterBackup_ClusterBackup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type UpdateClusterRestore_UpdateClusterRestore_ClusterRestoreFragment_Backup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateClusterRestore_CreateClusterRestore_ClusterRestoreFragment_Backup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GetClusterRestore_ClusterRestore_ClusterRestoreFragment_Backup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteBootstrapToken_DeleteBootstrapToken struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.Content
	...
	type CreateCluster_CreateCluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
func (t *CreateCluster_CreateCluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &CreateCluster_CreateCluster{}
}
return t.Metadata
...
return t.Content
	...
	type UpdateCluster_UpdateCluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type DeleteCluster_DeleteCluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DetachCluster_DetachCluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.Content
	...
	type CreateClusterProvider_CreateClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateClusterProvider_UpdateClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Components struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Group *string "json:\"group,omitempty\" graphql:\"group\""; Kind string "json:\"kind\" graphql:\"kind\""; Namespace *string "json:\"namespace,omitempty\" graphql:\"namespace\""; State *ComponentState "json:\"state,omitempty\" graphql:\"state\""; Synced bool "json:\"synced\" graphql:\"synced\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Content *ComponentContentFragment "json:\"content,omitempty\" graphql:\"content\""}
...
return t.Content
	...
	type UpdateClusterProvider_UpdateClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type DeleteClusterProvider_DeleteClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type PingCluster_PingCluster struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Content
	...
	type ListClusters_Clusters_Edges_ClusterEdgeFragment_Node_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListClusters_Clusters struct{Edges []*ClusterEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type GetCluster_Cluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Components struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Group *string "json:\"group,omitempty\" graphql:\"group\""; Kind string "json:\"kind\" graphql:\"kind\""; Namespace *string "json:\"namespace,omitempty\" graphql:\"namespace\""; State *ComponentState "json:\"state,omitempty\" graphql:\"state\""; Synced bool "json:\"synced\" graphql:\"synced\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Content *ComponentContentFragment "json:\"content,omitempty\" graphql:\"content\""}
...
return t.Content
	...
	type GetCluster_Cluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetAgentUrl_Cluster struct{AgentURL *string "json:\"agentUrl,omitempty\" graphql:\"agentUrl\""}
...
return t.Content
	...
	type GetClusterWithToken_Cluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
func (t *GetClusterWithToken_Cluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &GetClusterWithToken_Cluster{}
}
return t.Metadata
...
return t.Content
	...
	type GetClusterByHandle_Cluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type GetClusterProvider_ClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type GetClusterProviderByCloud_ClusterProvider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListServiceDeployments_ServiceDeployments_Edges_Node_ServiceDeploymentFragment_Components struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Group *string "json:\"group,omitempty\" graphql:\"group\""; Kind string "json:\"kind\" graphql:\"kind\""; Namespace *string "json:\"namespace,omitempty\" graphql:\"namespace\""; State *ComponentState "json:\"state,omitempty\" graphql:\"state\""; Synced bool "json:\"synced\" graphql:\"synced\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Content *ComponentContentFragment "json:\"content,omitempty\" graphql:\"content\""}
...
return t.Content
	...
	type ListServiceDeployments_ServiceDeployments_Edges_Node_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListServiceDeployments_ServiceDeployments_Edges struct{Node *ServiceDeploymentFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListServiceDeployments_ServiceDeployments struct{Edges []*ListServiceDeployments_ServiceDeployments_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type MyCluster_MyCluster__Restore_ClusterRestoreFragment_Backup_ClusterBackupFragment_Cluster struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type MyCluster_MyCluster_ struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Distro *ClusterDistro "json:\"distro,omitempty\" graphql:\"distro\""; Restore *ClusterRestoreFragment "json:\"restore,omitempty\" graphql:\"restore\""}
...
return t.Content
	...
	type UpsertVirtualCluster_UpsertVirtualCluster_ClusterFragment_Provider_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpsertVirtualCluster_UpsertVirtualCluster struct{DeployToken *string "json:\"deployToken,omitempty\" graphql:\"deployToken\""; ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Handle *string "json:\"handle,omitempty\" graphql:\"handle\""; Self *bool "json:\"self,omitempty\" graphql:\"self\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""; PingedAt *string "json:\"pingedAt,omitempty\" graphql:\"pingedAt\""; Protect *bool "json:\"protect,omitempty\" graphql:\"protect\""; CurrentVersion *string "json:\"currentVersion,omitempty\" graphql:\"currentVersion\""; KasURL *string "json:\"kasUrl,omitempty\" graphql:\"kasUrl\""; DeletedAt *string "json:\"deletedAt,omitempty\" graphql:\"deletedAt\""; Metadata map[string]any "json:\"metadata,omitempty\" graphql:\"metadata\""; Tags []*ClusterTags "json:\"tags,omitempty\" graphql:\"tags\""; Provider *ClusterProviderFragment "json:\"provider,omitempty\" graphql:\"provider\""; NodePools []*NodePoolFragment "json:\"nodePools,omitempty\" graphql:\"nodePools\""; Status *ClusterStatusFragment "json:\"status,omitempty\" graphql:\"status\""; Project *TinyProjectFragment "json:\"project,omitempty\" graphql:\"project\""}
...
func (t *UpsertVirtualCluster_UpsertVirtualCluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &UpsertVirtualCluster_UpsertVirtualCluster{}
}
return t.Metadata
...
return t.Project
	...
	type GetGlobalServiceDeployment_GlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GetGlobalServiceDeployment_GlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateGlobalServiceDeployment_CreateGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateGlobalServiceDeployment_CreateGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateGlobalServiceDeploymentFromTemplate_CreateGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateGlobalServiceDeploymentFromTemplate_CreateGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type UpdateGlobalServiceDeployment_UpdateGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type UpdateGlobalServiceDeployment_UpdateGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGlobalServiceDeployment_DeleteGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGlobalServiceDeployment_DeleteGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateServiceDeployment_CreateServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type CreateServiceDeployment_CreateServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type CreateServiceDeploymentWithHandle_CreateServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type CreateServiceDeploymentWithHandle_CreateServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type DeleteServiceDeployment_DeleteServiceDeployment_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type DetachServiceDeployment_DetachServiceDeployment_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateServiceDeployment_UpdateServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type UpdateServiceDeployment_UpdateServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateServiceDeploymentWithHandle_UpdateServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type UpdateServiceDeploymentWithHandle_UpdateServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type CloneServiceDeployment_CloneService_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type CloneServiceDeploymentWithHandle_CloneService_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type RollbackService_RollbackService_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type UpdateServiceComponents_UpdateServiceComponents_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Content
	...
	type AddServiceError_UpdateServiceComponents_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateDeploymentSettings_UpdateDeploymentSettings_DeploymentSettingsFragment_Ai_AISettingsFragment_Openai struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type UpdateDeploymentSettings_UpdateDeploymentSettings_DeploymentSettingsFragment_Ai_AISettingsFragment_Anthropic struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type GetDeploymentSettings_DeploymentSettings_DeploymentSettingsFragment_Ai_AISettingsFragment_Openai struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type GetDeploymentSettings_DeploymentSettings_DeploymentSettingsFragment_Ai_AISettingsFragment_Anthropic struct{Model *string "json:\"model,omitempty\" graphql:\"model\""}
...
return t.Model
	...
	type GetServiceDeployment_ServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type GetServiceDeployment_ServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetServiceDeploymentComponents_ServiceDeployment_Components struct{Kind string "json:\"kind\" graphql:\"kind\""; State *ComponentState "json:\"state,omitempty\" graphql:\"state\""}
...
return t.State
	...
	type GetServiceDeploymentComponents_ServiceDeployment struct{ID string "json:\"id\" graphql:\"id\""; Components []*GetServiceDeploymentComponents_ServiceDeployment_Components "json:\"components,omitempty\" graphql:\"components\""}
...
func (t *GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Cluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Cluster{}
}
return t.Metadata
...
return t.Distro
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Kustomize struct{Path string "json:\"path\" graphql:\"path\""}
...
return t.Path
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Helm struct{Release *string "json:\"release,omitempty\" graphql:\"release\""; ValuesFiles []*string "json:\"valuesFiles,omitempty\" graphql:\"valuesFiles\""; IgnoreHooks *bool "json:\"ignoreHooks,omitempty\" graphql:\"ignoreHooks\""}
...
return t.IgnoreHooks
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Contexts struct{Name string "json:\"name\" graphql:\"name\""; Configuration map[string]any "json:\"configuration,omitempty\" graphql:\"configuration\""}
...
func (t *GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Contexts) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Contexts{}
}
return t.Configuration
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata struct{Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Annotations map[string]any "json:\"annotations,omitempty\" graphql:\"annotations\""}

    func (t *GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetLabels() map[string]*types.Alias----{
if t == nil {
 t = &GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Labels
}
func (t *GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Annotations
...
return t.NamespaceMetadata
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Revision struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Imports_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type GetServiceDeploymentForAgent_ServiceDeployment_ServiceDeploymentForAgent_Imports_Outputs struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Outputs
	...
	type GetServiceDeploymentByHandle_ServiceDeployment_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type GetServiceDeploymentByHandle_ServiceDeployment_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListServiceDeployment_ServiceDeployments struct{Edges []*ServiceDeploymentEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type PagedClusterServices_PagedClusterServices struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ServiceDeploymentEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
func (t *PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Cluster) GetMetadata() map[string]*types.Alias----{
if t == nil {
 t = &PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Cluster{}
}
return t.Metadata
...
return t.Distro
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Kustomize struct{Path string "json:\"path\" graphql:\"path\""}
...
return t.IgnoreHooks
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts struct{Name string "json:\"name\" graphql:\"name\""; Configuration map[string]any "json:\"configuration,omitempty\" graphql:\"configuration\""}
...
func (t *PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts) GetConfiguration() map[string]*types.Alias----{
if t == nil {
 t = &PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Contexts{}
}
return t.Configuration
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata struct{Labels map[string]any "json:\"labels,omitempty\" graphql:\"labels\""; Annotations map[string]any "json:\"annotations,omitempty\" graphql:\"annotations\""}

    func (t *PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetLabels() map[string]*types.Alias----{
if t == nil {
...
func (t *PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata) GetAnnotations() map[string]*types.Alias----{
if t == nil {
 t = &PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_SyncConfig_NamespaceMetadata{}
}
return t.Annotations
...
return t.NamespaceMetadata
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Revision struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Imports_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type PagedClusterServicesForAgent_PagedClusterServices_Edges_ServiceDeploymentEdgeFragmentForAgent_Node_ServiceDeploymentForAgent_Imports_Outputs struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""; Secret *bool "json:\"secret,omitempty\" graphql:\"secret\""}
...
return t.Outputs
	...
	type PagedClusterServicesForAgent_PagedClusterServices struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ServiceDeploymentEdgeFragmentForAgent "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type PagedClusterServiceIds_PagedClusterServices struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ServiceDeploymentIDEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListServiceDeploymentByHandle_ServiceDeployments struct{Edges []*ServiceDeploymentEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type CreateGlobalService_CreateGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type CreateGlobalService_CreateGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type UpdateGlobalService_UpdateGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type UpdateGlobalService_UpdateGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGlobalService_DeleteGlobalService_GlobalServiceFragment_Provider struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGlobalService_DeleteGlobalService_GlobalServiceFragment_Service struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type KickService_KickService_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type KickService_KickService_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type KickServiceByHandle_KickService_ServiceDeploymentExtended_Revision_RevisionFragment_Git struct{Ref string "json:\"ref\" graphql:\"ref\""; Folder string "json:\"folder\" graphql:\"folder\""}
...
return t.Content
	...
	type KickServiceByHandle_KickService_ServiceDeploymentExtended_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetClusterRegistrations_ClusterRegistrations_Edges struct{Node *ClusterRegistrationFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type GetClusterRegistrations_ClusterRegistrations struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*GetClusterRegistrations_ClusterRegistrations_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type GetClusterGates_ClusterGates_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetClusterGates_ClusterGates_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type PagedClusterGates_PagedClusterGates_Edges_PipelineGateEdgeFragment_Node_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type PagedClusterGates_PagedClusterGates_Edges_PipelineGateEdgeFragment_Node_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type PagedClusterGates_PagedClusterGates struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*PipelineGateEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type PagedClusterGateIDs_PagedClusterGates_Edges_PipelineGateIDsEdgeFragment_Node_ struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type PagedClusterGateIDs_PagedClusterGates struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*PipelineGateIDsEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type UpdateGate_UpdateGate_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateGate_UpdateGate_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetClusterGate_ClusterGate_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetClusterGate_ClusterGate_PipelineGateFragment_Spec_GateSpecFragment_Job_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListGitRepositories_GitRepositories struct{Edges []*GitRepositoryEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListScmConnections_ScmConnections_Edges struct{Node *ScmConnectionFragment "json:\"node,omitempty\" graphql:\"node\""; Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""}
...
return t.Cursor
	...
	type ListScmConnections_ScmConnections struct{Edges []*ListScmConnections_ScmConnections_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListPrAutomations_PrAutomations_Edges struct{Node *PrAutomationFragment "json:\"node,omitempty\" graphql:\"node\""; Cursor *string "json:\"cursor,omitempty\" graphql:\"cursor\""}
...
return t.Cursor
	...
	type ListPrAutomations_PrAutomations struct{Edges []*ListPrAutomations_PrAutomations_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListHelmRepositories_HelmRepositories_Edges struct{Node *HelmRepositoryFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListHelmRepositories_HelmRepositories struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ListHelmRepositories_HelmRepositories_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListNamespaces_ManagedNamespaces struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ManagedNamespaceEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListClusterNamespaces_ClusterManagedNamespaces struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ManagedNamespaceEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type DeleteNamespace_DeleteManagedNamespace struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type ListNotificationSinks_NotificationSinks struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*NotificationSinkEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListObservabilityProviders_ObservabilityProviders_Edges struct{Node *ObservabilityProviderFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListObservabilityProviders_ObservabilityProviders struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ListObservabilityProviders_ObservabilityProviders_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type GetPipelines_Pipelines_Edges_PipelineEdgeFragment_Node_PipelineFragment_Stages_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type GetPipelines_Pipelines_Edges_PipelineEdgeFragment_Node_PipelineFragment_Edges_PipelineStageEdgeFragment_From_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type GetPipelines_Pipelines_Edges_PipelineEdgeFragment_Node_PipelineFragment_Edges_PipelineStageEdgeFragment_To_PipelineStageFragment_Services_Criteria struct{Source *ServiceDeploymentBaseFragment "json:\"source,omitempty\" graphql:\"source\""; Secrets []*string "json:\"secrets,omitempty\" graphql:\"secrets\""}
...
return t.Criteria
	...
	type GetPipelines_Pipelines struct{Edges []*PipelineEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListProjects_Projects_Edges struct{Node *ProjectFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListProjects_Projects struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ListProjects_Projects_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Content
	...
	type ListProviders_ClusterProviders_Edges_Node_ClusterProviderFragment_Service_ServiceDeploymentFragment_Configuration struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListProviders_ClusterProviders_Edges struct{Node *ClusterProviderFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListProviders_ClusterProviders struct{Edges []*ListProviders_ClusterProviders_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ServiceAccounts_ServiceAccounts_Edges struct{Node *UserFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ServiceAccounts_ServiceAccounts struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ServiceAccounts_ServiceAccounts_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ShareSecret_ShareSecret struct{Name string "json:\"name\" graphql:\"name\""; Handle string "json:\"handle\" graphql:\"handle\""; Secret string "json:\"secret\" graphql:\"secret\""; InsertedAt *string "json:\"insertedAt,omitempty\" graphql:\"insertedAt\""; UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""}
...
return t.UpdatedAt
	...
	type ListClusterStacks_ClusterStackRuns_Edges_StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Terraform
	...
	type ListClusterStacks_ClusterStackRuns_Edges_StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type ListClusterStacks_ClusterStackRuns_Edges_StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Secret
	...
	type ListClusterStacks_ClusterStackRuns_Edges_StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListClusterStacks_ClusterStackRuns_Edges_StackRunEdgeFragment_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListClusterStacks_ClusterStackRuns struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*StackRunEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListClusterStackIds_ClusterStackRuns struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*StackRunIDEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListClusterMinimalStacks_ClusterStackRuns_Edges_MinimalStackRunEdgeFragment_Node_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListClusterMinimalStacks_ClusterStackRuns_Edges_MinimalStackRunEdgeFragment_Node_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListClusterMinimalStacks_ClusterStackRuns struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*MinimalStackRunEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListInfrastructureStacks_InfrastructureStacks_Edges_InfrastructureStackEdgeFragment_Node_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListInfrastructureStacks_InfrastructureStacks_Edges_InfrastructureStackEdgeFragment_Node_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListInfrastructureStacks_InfrastructureStacks struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*InfrastructureStackEdgeFragment "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type GetStackRunMinimal_StackRun_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetStackRunMinimal_StackRun_StackRunMinimalFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_StateUrls struct{Terraform *GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetStackRun_StackRun_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_StateUrls struct{Terraform *GetStackRunBase_StackRun_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetStackRunBase_StackRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_StateUrls struct{Terraform *UpdateStackRun_UpdateStackRun_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateStackRun_UpdateStackRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type CreateStack_CreateStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type CreateStack_CreateStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type UpdateStack_UpdateStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type UpdateStack_UpdateStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetInfrastructureStack_InfrastructureStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type GetInfrastructureStack_InfrastructureStack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type AddStackRunLogs_AddRunLogs struct{UpdatedAt *string "json:\"updatedAt,omitempty\" graphql:\"updatedAt\""}
...
return t.UpdatedAt
	...
	type UpdateCustomStackRun_UpdateCustomStackRun_CustomStackRunFragment_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type CreateCustomStackRun_CreateCustomStackRun_CustomStackRunFragment_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteCustomStackRun_DeleteCustomStackRun_CustomStackRunFragment_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type GetCustomStackRun_CustomStackRun_CustomStackRunFragment_Stack struct{ID *string "json:\"id,omitempty\" graphql:\"id\""}
...
return t.ID
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_StateUrls struct{Terraform *ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges_Node_StackRunFragment_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type ListStackRuns_InfrastructureStack_Runs_Edges struct{Node *StackRunFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListStackRuns_InfrastructureStack_Runs struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ListStackRuns_InfrastructureStack_Runs_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type ListStackRuns_InfrastructureStack struct{Runs *ListStackRuns_InfrastructureStack_Runs "json:\"runs,omitempty\" graphql:\"runs\""}
...
return t.Runs
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_StateUrls_Terraform struct{Address *string "json:\"address,omitempty\" graphql:\"address\""; Lock *string "json:\"lock,omitempty\" graphql:\"lock\""; Unlock *string "json:\"unlock,omitempty\" graphql:\"unlock\""}
...
return t.Unlock
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_StateUrls struct{Terraform *TriggerRun_TriggerRun_StackRunBaseFragment_StateUrls_Terraform "json:\"terraform,omitempty\" graphql:\"terraform\""}
...
return t.Terraform
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_PluralCreds struct{URL *string "json:\"url,omitempty\" graphql:\"url\""; Token *string "json:\"token,omitempty\" graphql:\"token\""}
...
return t.Token
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_Stack_InfrastructureStackFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_Env struct{Name string "json:\"name\" graphql:\"name\""; Value string "json:\"value\" graphql:\"value\""}
...
return t.Value
	...
	type TriggerRun_TriggerRun_StackRunBaseFragment_JobSpec_JobSpecFragment_Containers_ContainerSpecFragment_EnvFrom struct{ConfigMap string "json:\"configMap\" graphql:\"configMap\""; Secret string "json:\"secret\" graphql:\"secret\""}
...
return t.Secret
	...
	type GetStackDefinition_StackDefinition_StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return t.Hooks
	...
	type GetStackDefinition_StackDefinition_StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type ListStackDefinitions_StackDefinitions_Edges_Node_StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return t.Hooks
	...
	type ListStackDefinitions_StackDefinitions_Edges_Node_StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type ListStackDefinitions_StackDefinitions_Edges struct{Node *StackDefinitionFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListStackDefinitions_StackDefinitions struct{PageInfo PageInfoFragment "json:\"pageInfo\" graphql:\"pageInfo\""; Edges []*ListStackDefinitions_StackDefinitions_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type CreateStackDefinition_CreateStackDefinition_StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return t.Hooks
	...
	type CreateStackDefinition_CreateStackDefinition_StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type UpdateStackDefinition_UpdateStackDefinition_StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return &t.AfterStage
	...
	type UpdateStackDefinition_UpdateStackDefinition_StackDefinitionFragment_Configuration struct{Image *string "json:\"image,omitempty\" graphql:\"image\""; Tag *string "json:\"tag,omitempty\" graphql:\"tag\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Hooks []*UpdateStackDefinition_UpdateStackDefinition_StackDefinitionFragment_Configuration_Hooks "json:\"hooks,omitempty\" graphql:\"hooks\""}
...
return t.Hooks
	...
	type UpdateStackDefinition_UpdateStackDefinition_StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type DeleteStackDefinition_DeleteStackDefinition_StackDefinitionFragment_Configuration_Hooks struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; AfterStage StepStage "json:\"afterStage\" graphql:\"afterStage\""}
...
return &t.AfterStage
	...
	type DeleteStackDefinition_DeleteStackDefinition_StackDefinitionFragment_Configuration struct{Image *string "json:\"image,omitempty\" graphql:\"image\""; Tag *string "json:\"tag,omitempty\" graphql:\"tag\""; Version *string "json:\"version,omitempty\" graphql:\"version\""; Hooks []*DeleteStackDefinition_DeleteStackDefinition_StackDefinitionFragment_Configuration_Hooks "json:\"hooks,omitempty\" graphql:\"hooks\""}
...
return t.Hooks
	...
	type DeleteStackDefinition_DeleteStackDefinition_StackDefinitionFragment_Steps struct{Cmd string "json:\"cmd\" graphql:\"cmd\""; Args []*string "json:\"args,omitempty\" graphql:\"args\""; Stage StepStage "json:\"stage\" graphql:\"stage\""; RequireApproval *bool "json:\"requireApproval,omitempty\" graphql:\"requireApproval\""}
...
return t.RequireApproval
	...
	type ListAccessTokens_AccessTokens_Edges struct{Node *AccessTokenFragment "json:\"node,omitempty\" graphql:\"node\""}
...
return t.Node
	...
	type ListAccessTokens_AccessTokens struct{Edges []*ListAccessTokens_AccessTokens_Edges "json:\"edges,omitempty\" graphql:\"edges\""}
...
return t.Edges
	...
	type TokenExchange_TokenExchange_Groups struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.Name
	...
	type TokenExchange_TokenExchange_BoundRoles struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""}
...
return t.BoundRoles
	...
	type SaveUpgradeInsights_SaveUpgradeInsights struct{ID string "json:\"id\" graphql:\"id\""; Name string "json:\"name\" graphql:\"name\""; Version *string "json:\"version,omitempty\" graphql:\"version\""}
...
return t.Version
	...
	type AddGroupMember_CreateGroupMember_GroupMemberFragment_User struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type AddGroupMember_CreateGroupMember_GroupMemberFragment_Group struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGroupMember_DeleteGroupMember_GroupMemberFragment_User struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type DeleteGroupMember_DeleteGroupMember_GroupMemberFragment_Group struct{ID string "json:\"id\" graphql:\"id\""}
...
return t.ID
	...
	type  AddClusterAuditLog struct{AddClusterAuditLog *bool "json:\"addClusterAuditLog,omitempty\" graphql:\"addClusterAuditLog\""}
...
return t.AddClusterAuditLog
	...
	type  CreateClusterBackup struct{CreateClusterBackup *ClusterBackupFragment "json:\"createClusterBackup,omitempty\" graphql:\"createClusterBackup\""}
...
return t.CreateClusterBackup
	...
	type  GetClusterBackup struct{ClusterBackup *ClusterBackupFragment "json:\"clusterBackup,omitempty\" graphql:\"clusterBackup\""}
...
return t.ClusterBackup
	...
	type  UpdateClusterRestore struct{UpdateClusterRestore *ClusterRestoreFragment "json:\"updateClusterRestore,omitempty\" graphql:\"updateClusterRestore\""}
...
return t.UpdateClusterRestore
	...
	type  CreateClusterRestore struct{CreateClusterRestore *ClusterRestoreFragment "json:\"createClusterRestore,omitempty\" graphql:\"createClusterRestore\""}
...
return t.CreateClusterRestore
	...
	type  GetClusterRestore struct{ClusterRestore *ClusterRestoreFragment "json:\"clusterRestore,omitempty\" graphql:\"clusterRestore\""}
...
return t.ClusterRestore
	...
	type  CreateBootstrapToken struct{CreateBootstrapToken *BootstrapTokenBase "json:\"createBootstrapToken,omitempty\" graphql:\"createBootstrapToken\""}
...
return t.CreateBootstrapToken
	...
	type  DeleteBootstrapToken struct{DeleteBootstrapToken *DeleteBootstrapToken_DeleteBootstrapToken "json:\"deleteBootstrapToken,omitempty\" graphql:\"deleteBootstrapToken\""}
...
return t.DeleteBootstrapToken
	...
	type  UpsertCatalog struct{UpsertCatalog *CatalogFragment "json:\"upsertCatalog,omitempty\" graphql:\"upsertCatalog\""}
...
return t.UpsertCatalog
	...
	type  DeleteCatalog struct{DeleteCatalog *CatalogFragment "json:\"deleteCatalog,omitempty\" graphql:\"deleteCatalog\""}
...
return t.DeleteCatalog
	...
	type  GetCatalog struct{Catalog *CatalogFragment "json:\"catalog,omitempty\" graphql:\"catalog\""}
...
return t.Catalog
	...
	type  CreateCluster struct{CreateCluster *CreateCluster_CreateCluster "json:\"createCluster,omitempty\" graphql:\"createCluster\""}
...
return t.CreateCluster
	...
	type  UpdateCluster struct{UpdateCluster *ClusterFragment "json:\"updateCluster,omitempty\" graphql:\"updateCluster\""}
...
return t.UpdateCluster
	...
	type  DeleteCluster struct{DeleteCluster *DeleteCluster_DeleteCluster "json:\"deleteCluster,omitempty\" graphql:\"deleteCluster\""}
...
return t.DeleteCluster
	...
	type  DetachCluster struct{DetachCluster *DetachCluster_DetachCluster "json:\"detachCluster,omitempty\" graphql:\"detachCluster\""}
...
return t.DetachCluster
	...
	type  CreateClusterProvider struct{CreateClusterProvider *ClusterProviderFragment "json:\"createClusterProvider,omitempty\" graphql:\"createClusterProvider\""}
...
return t.CreateClusterProvider
	...
	type  UpdateClusterProvider struct{UpdateClusterProvider *ClusterProviderFragment "json:\"updateClusterProvider,omitempty\" graphql:\"updateClusterProvider\""}
...
return t.UpdateClusterProvider
	...
	type  DeleteClusterProvider struct{DeleteClusterProvider *ClusterProviderFragment "json:\"deleteClusterProvider,omitempty\" graphql:\"deleteClusterProvider\""}
...
return t.PingCluster
	...
	type  RegisterRuntimeServices struct{RegisterRuntimeServices *int64 "json:\"registerRuntimeServices,omitempty\" graphql:\"registerRuntimeServices\""}
...
return t.RegisterRuntimeServices
	...
	type  ListClusters struct{Clusters *ListClusters_Clusters "json:\"clusters,omitempty\" graphql:\"clusters\""}
...
return t.Clusters
	...
	type  GetCluster struct{Cluster *ClusterFragment "json:\"cluster,omitempty\" graphql:\"cluster\""}
...
return t.Cluster
	...
	type  GetTinyCluster struct{Cluster *TinyClusterFragment "json:\"cluster,omitempty\" graphql:\"cluster\""}
...
return t.Cluster
	...
	type  GetAgentURL struct{Cluster *GetAgentUrl_Cluster "json:\"cluster,omitempty\" graphql:\"cluster\""}
...
return t.Cluster
	...
	type  GetClusterWithToken struct{Cluster *GetClusterWithToken_Cluster "json:\"cluster,omitempty\" graphql:\"cluster\""}
...
return t.Cluster
	...
	type  GetClusterByHandle struct{Cluster *ClusterFragment "json:\"cluster,omitempty\" graphql:\"cluster\""}
...
return t.Cluster
	...
	type  GetClusterProvider struct{ClusterProvider *ClusterProviderFragment "json:\"clusterProvider,omitempty\" graphql:\"clusterProvider\""}
...
return t.ClusterProvider
	...
	type  GetClusterProviderByCloud struct{ClusterProvider *ClusterProviderFragment "json:\"clusterProvider,omitempty\" graphql:\"clusterProvider\""}
...
return t.ClusterProvider
	...
	type  ListClusterServices struct{ClusterServices []*ServiceDeploymentBaseFragment "json:\"clusterServices,omitempty\" graphql:\"clusterServices\""}
...
return t.ClusterServices
	...
	type  ListServiceDeployments struct{ServiceDeployments *ListServiceDeployments_ServiceDeployments "json:\"serviceDeployments,omitempty\" graphql:\"serviceDeployments\""}
...
return t.ServiceDeployments
	...
	type  MyCluster struct{MyCluster *MyCluster_MyCluster_ "json:\"myCluster,omitempty\" graphql:\"myCluster\""}
...
return t.MyCluster
	...
	type  UpsertVirtualCluster struct{UpsertVirtualCluster *UpsertVirtualCluster_UpsertVirtualCluster "json:\"upsertVirtualCluster,omitempty\" graphql:\"upsertVirtualCluster\""}
...
return t.UpsertVirtualCluster
	...
	type  GetGlobalServiceDeployment struct{GlobalService *GlobalServiceFragment "json:\"globalService,omitempty\" graphql:\"globalService\""}
...
return t.GlobalService
	...
	type  CreateGlobalServiceDeployment struct{CreateGlobalService *GlobalServiceFragment "json:\"createGlobalService,omitempty\" graphql:\"createGlobalService\""}
...
return t.CreateGlobalService
	...
	type  CreateGlobalServiceDeploymentFromTemplate struct{CreateGlobalService *GlobalServiceFragment "json:\"createGlobalService,omitempty\" graphql:\"createGlobalService\""}
...
return t.CreateGlobalService
	...
	type  UpdateGlobalServiceDeployment struct{UpdateGlobalService *GlobalServiceFragment "json:\"updateGlobalService,omitempty\" graphql:\"updateGlobalService\""}
...
return t.UpdateGlobalService
	...
	type  DeleteGlobalServiceDeployment struct{DeleteGlobalService *GlobalServiceFragment "json:\"deleteGlobalService,omitempty\" graphql:\"deleteGlobalService\""}
...
return t.DeleteGlobalService
	...
	type  CreateServiceDeployment struct{CreateServiceDeployment *ServiceDeploymentExtended "json:\"createServiceDeployment,omitempty\" graphql:\"createServiceDeployment\""}
...
return t.CreateServiceDeployment
	...
	type  CreateServiceDeploymentWithHandle struct{CreateServiceDeployment *ServiceDeploymentExtended "json:\"createServiceDeployment,omitempty\" graphql:\"createServiceDeployment\""}
...
return t.CreateServiceDeployment
	...
	type  DeleteServiceDeployment struct{DeleteServiceDeployment *ServiceDeploymentFragment "json:\"deleteServiceDeployment,omitempty\" graphql:\"deleteServiceDeployment\""}
...
return t.DeleteServiceDeployment
	...
	type  DetachServiceDeployment struct{DetachServiceDeployment *ServiceDeploymentFragment "json:\"detachServiceDeployment,omitempty\" graphql:\"detachServiceDeployment\""}
...
return t.DetachServiceDeployment
	...
	type  UpdateServiceDeployment struct{UpdateServiceDeployment *ServiceDeploymentExtended "json:\"updateServiceDeployment,omitempty\" graphql:\"updateServiceDeployment\""}
...
return t.UpdateServiceDeployment
	...
	type  UpdateServiceDeploymentWithHandle struct{UpdateServiceDeployment *ServiceDeploymentExtended "json:\"updateServiceDeployment,omitempty\" graphql:\"updateServiceDeployment\""}
...
return t.UpdateServiceDeployment
	...
	type  CloneServiceDeployment struct{CloneService *ServiceDeploymentFragment "json:\"cloneService,omitempty\" graphql:\"cloneService\""}
...
return t.CloneService
	...
	type  CloneServiceDeploymentWithHandle struct{CloneService *ServiceDeploymentFragment "json:\"cloneService,omitempty\" graphql:\"cloneService\""}
...
return t.CloneService
	...
	type  RollbackService struct{RollbackService *ServiceDeploymentFragment "json:\"rollbackService,omitempty\" graphql:\"rollbackService\""}
...
return t.RollbackService
	...
	type  UpdateServiceComponents struct{UpdateServiceComponents *ServiceDeploymentFragment "json:\"updateServiceComponents,omitempty\" graphql:\"updateServiceComponents\""}
...
return t.UpdateServiceComponents
	...
	type  AddServiceError struct{UpdateServiceComponents *ServiceDeploymentFragment "json:\"updateServiceComponents,omitempty\" graphql:\"updateServiceComponents\""}
...
return t.UpdateServiceComponents
	...
	type  UpdateDeploymentSettings struct{UpdateDeploymentSettings *DeploymentSettingsFragment "json:\"updateDeploymentSettings,omitempty\" graphql:\"updateDeploymentSettings\""}
...
return t.UpdateDeploymentSettings
	...
	type  GetDeploymentSettings struct{DeploymentSettings *DeploymentSettingsFragment "json:\"deploymentSettings,omitempty\" graphql:\"deploymentSettings\""}
...
return t.DeploymentSettings
	...
	type  GetServiceDeployment struct{ServiceDeployment *ServiceDeploymentExtended "json:\"serviceDeployment,omitempty\" graphql:\"serviceDeployment\""}
...
return t.ServiceDeployment
	...
	type  GetServiceDeploymentComponents struct{ServiceDeployment *GetServiceDeploymentComponents_ServiceDeployment "json:\"serviceDeployment,omitempty\" graphql:\"serviceDeployment\""}
...
return t.ServiceDeployment
	...
	type  GetServiceDeploymentForAgent struct{ServiceDeployment *ServiceDeploymentForAgent "json:\"serviceDeployment,omitempty\" graphql:\"serviceDeployment\""}
...
return t.ServiceDeployment
	...
	type  GetServiceDeploymentByHandle struct{ServiceDeployment *ServiceDeploymentExtended "json:\"serviceDeployment,omitempty\" graphql:\"serviceDeployment\""}
...
return t.ServiceDeployment
	...
	type  ListServiceDeployment struct{ServiceDeployments *ListServiceDeployment_ServiceDeployments "json:\"serviceDeployments,omitempty\" graphql:\"serviceDeployments\""}
...
return t.ServiceDeployments
	...
	type  PagedClusterServices struct{PagedClusterServices *PagedClusterServices_PagedClusterServices "json:\"pagedClusterServices,omitempty\" graphql:\"pagedClusterServices\""}
...
return t.PagedClusterServices
	...
	type  PagedClusterServicesForAgent struct{PagedClusterServices *PagedClusterServicesForAgent_PagedClusterServices "json:\"pagedClusterServices,omitempty\" graphql:\"pagedClusterServices\""}
...
return t.PagedClusterServices
	...
	type  PagedClusterServiceIds struct{PagedClusterServices *PagedClusterServiceIds_PagedClusterServices "json:\"pagedClusterServices,omitempty\" graphql:\"pagedClusterServices\""}
...
return t.PagedClusterServices
	...
	type  ListServiceDeploymentByHandle struct{ServiceDeployments *ListServiceDeploymentByHandle_ServiceDeployments "json:\"serviceDeployments,omitempty\" graphql:\"serviceDeployments\""}
...
return t.ServiceDeployments
	...
	type  GetServiceContext struct{ServiceContext *ServiceContextFragment "json:\"serviceContext,omitempty\" graphql:\"serviceContext\""}
...
return t.ServiceContext
	...
	type  SaveServiceContext struct{SaveServiceContext *ServiceContextFragment "json:\"saveServiceContext,omitempty\" graphql:\"saveServiceContext\""}
...
return t.SaveServiceContext
	...
	type  DeleteServiceContext struct{DeleteServiceContext *ServiceContextFragment "json:\"deleteServiceContext,omitempty\" graphql:\"deleteServiceContext\""}
...
return t.DeleteServiceContext
	...
	type  CreateGlobalService struct{CreateGlobalService *GlobalServiceFragment "json:\"createGlobalService,omitempty\" graphql:\"createGlobalService\""}
...
return t.CreateGlobalService
	...
	type  UpdateGlobalService struct{UpdateGlobalService *GlobalServiceFragment "json:\"updateGlobalService,omitempty\" graphql:\"updateGlobalService\""}
...
return t.UpdateGlobalService
	...
	type  DeleteGlobalService struct{DeleteGlobalService *GlobalServiceFragment "json:\"deleteGlobalService,omitempty\" graphql:\"deleteGlobalService\""}
...
return t.DeleteGlobalService
	...
	type  KickService struct{KickService *ServiceDeploymentExtended "json:\"kickService,omitempty\" graphql:\"kickService\""}
...
return t.KickService
	...
	type  KickServiceByHandle struct{KickService *ServiceDeploymentExtended "json:\"kickService,omitempty\" graphql:\"kickService\""}
...
return t.KickService
	...
	type  GetClusterRegistration struct{ClusterRegistration *ClusterRegistrationFragment "json:\"clusterRegistration,omitempty\" graphql:\"clusterRegistration\""}
...
return t.ClusterRegistration
	...
	type  GetClusterRegistrations struct{ClusterRegistrations *GetClusterRegistrations_ClusterRegistrations "json:\"clusterRegistrations,omitempty\" graphql:\"clusterRegistrations\""}
...
return t.ClusterRegistrations
	...
	type  CreateClusterRegistration struct{CreateClusterRegistration *ClusterRegistrationFragment "json:\"createClusterRegistration,omitempty\" graphql:\"createClusterRegistration\""}
...
return t.CreateClusterRegistration
	...
	type  UpdateClusterRegistration struct{UpdateClusterRegistration *ClusterRegistrationFragment "json:\"updateClusterRegistration,omitempty\" graphql:\"updateClusterRegistration\""}
...
return t.UpdateClusterRegistration
	...
	type  DeleteClusterRegistration struct{DeleteClusterRegistration *ClusterRegistrationFragment "json:\"deleteClusterRegistration,omitempty\" graphql:\"deleteClusterRegistration\""}
...
return t.DeleteClusterRegistration
	...
	type  CreateClusterIsoImage struct{CreateClusterIsoImage *ClusterIsoImageFragment "json:\"createClusterIsoImage,omitempty\" graphql:\"createClusterIsoImage\""}
...
return t.CreateClusterIsoImage
	...
	type  UpdateClusterIsoImage struct{UpdateClusterIsoImage *ClusterIsoImageFragment "json:\"updateClusterIsoImage,omitempty\" graphql:\"updateClusterIsoImage\""}
...
return t.UpdateClusterIsoImage
	...
	type  DeleteClusterIsoImage struct{DeleteClusterIsoImage *ClusterIsoImageFragment "json:\"deleteClusterIsoImage,omitempty\" graphql:\"deleteClusterIsoImage\""}
...
return t.DeleteClusterIsoImage
	...
	type  GetClusterIsoImage struct{ClusterIsoImage *ClusterIsoImageFragment "json:\"clusterIsoImage,omitempty\" graphql:\"clusterIsoImage\""}
...
return t.ClusterIsoImage
	...
	type  GetClusterGates struct{ClusterGates []*PipelineGateFragment "json:\"clusterGates,omitempty\" graphql:\"clusterGates\""}
...
return t.ClusterGates
	...
	type  PagedClusterGates struct{PagedClusterGates *PagedClusterGates_PagedClusterGates "json:\"pagedClusterGates,omitempty\" graphql:\"pagedClusterGates\""}
...
return t.PagedClusterGates
	...
	type  PagedClusterGateIDs struct{PagedClusterGates *PagedClusterGateIDs_PagedClusterGates "json:\"pagedClusterGates,omitempty\" graphql:\"pagedClusterGates\""}
...
return t.PagedClusterGates
	...
	type  UpdateGate struct{UpdateGate *PipelineGateFragment "json:\"updateGate,omitempty\" graphql:\"updateGate\""}
...
return t.UpdateGate
	...
	type  GetClusterGate struct{ClusterGate *PipelineGateFragment "json:\"clusterGate,omitempty\" graphql:\"clusterGate\""}
...
return t.ClusterGate
	...
	type  CreateGitRepository struct{CreateGitRepository *GitRepositoryFragment "json:\"createGitRepository,omitempty\" graphql:\"createGitRepository\""}
...
return t.CreateGitRepository
	...
	type  UpdateGitRepository struct{UpdateGitRepository *GitRepositoryFragment "json:\"updateGitRepository,omitempty\" graphql:\"updateGitRepository\""}
...
return t.UpdateGitRepository
	...
	type  DeleteGitRepository struct{DeleteGitRepository *GitRepositoryFragment "json:\"deleteGitRepository,omitempty\" graphql:\"deleteGitRepository\""}
...
return t.DeleteGitRepository
	...
	type  ListGitRepositories struct{GitRepositories *ListGitRepositories_GitRepositories "json:\"gitRepositories,omitempty\" graphql:\"gitRepositories\""}
...
return t.GitRepositories
	...
	type  GetGitRepository struct{GitRepository *GitRepositoryFragment "json:\"gitRepository,omitempty\" graphql:\"gitRepository\""}
...
return t.GitRepository
	...
	type  GetScmConnection struct{ScmConnection *ScmConnectionFragment "json:\"scmConnection,omitempty\" graphql:\"scmConnection\""}
...
return t.ScmConnection
	...
	type  GetScmConnectionByName struct{ScmConnection *ScmConnectionFragment "json:\"scmConnection,omitempty\" graphql:\"scmConnection\""}
...
return t.ScmConnection
	...
	type  ListScmConnections struct{ScmConnections *ListScmConnections_ScmConnections "json:\"scmConnections,omitempty\" graphql:\"scmConnections\""}
...
return t.ScmConnections
	...
	type  CreateScmConnection struct{CreateScmConnection *ScmConnectionFragment "json:\"createScmConnection,omitempty\" graphql:\"createScmConnection\""}
...
return t.CreateScmConnection
	...
	type  UpdateScmConnection struct{UpdateScmConnection *ScmConnectionFragment "json:\"updateScmConnection,omitempty\" graphql:\"updateScmConnection\""}
...
return t.UpdateScmConnection
	...
	type  DeleteScmConnection struct{DeleteScmConnection *ScmConnectionFragment "json:\"deleteScmConnection,omitempty\" graphql:\"deleteScmConnection\""}
...
return t.DeleteScmConnection
	...
	type  GetPrAutomation struct{PrAutomation *PrAutomationFragment "json:\"prAutomation,omitempty\" graphql:\"prAutomation\""}
...
return t.PrAutomation
	...
	type  GetPrAutomationByName struct{PrAutomation *PrAutomationFragment "json:\"prAutomation,omitempty\" graphql:\"prAutomation\""}
...
return t.PrAutomation
	...
	type  ListPrAutomations struct{PrAutomations *ListPrAutomations_PrAutomations "json:\"prAutomations,omitempty\" graphql:\"prAutomations\""}
...
return t.PrAutomations
	...
	type  CreatePrAutomation struct{CreatePrAutomation *PrAutomationFragment "json:\"createPrAutomation,omitempty\" graphql:\"createPrAutomation\""}
...
return t.CreatePrAutomation
	...
	type  UpdatePrAutomation struct{UpdatePrAutomation *PrAutomationFragment "json:\"updatePrAutomation,omitempty\" graphql:\"updatePrAutomation\""}
...
return t.UpdatePrAutomation
	...
	type  DeletePrAutomation struct{DeletePrAutomation *PrAutomationFragment "json:\"deletePrAutomation,omitempty\" graphql:\"deletePrAutomation\""}
...
return t.DeletePrAutomation
	...
	type  CreatePullRequest struct{CreatePullRequest *PullRequestFragment "json:\"createPullRequest,omitempty\" graphql:\"createPullRequest\""}
...
return t.CreatePullRequest
	...
	type  GetGroup struct{Group *GroupFragment "json:\"group,omitempty\" graphql:\"group\""}
...
return t.Group
	...
	type  CreateGroup struct{CreateGroup *GroupFragment "json:\"createGroup,omitempty\" graphql:\"createGroup\""}
...
return t.CreateGroup
	...
	type  UpdateGroup struct{UpdateGroup *GroupFragment "json:\"updateGroup,omitempty\" graphql:\"updateGroup\""}
...
return t.UpdateGroup
	...
	type  DeleteGroup struct{DeleteGroup *GroupFragment "json:\"deleteGroup,omitempty\" graphql:\"deleteGroup\""}
...
return t.DeleteGroup
	...
	type  ListHelmRepositories struct{HelmRepositories *ListHelmRepositories_HelmRepositories "json:\"helmRepositories,omitempty\" graphql:\"helmRepositories\""}
...
return t.HelmRepositories
	...
	type  GetHelmRepository struct{HelmRepository *HelmRepositoryFragment "json:\"helmRepository,omitempty\" graphql:\"helmRepository\""}
...
return t.HelmRepository
	...
	type  UpsertHelmRepository struct{UpsertHelmRepository *HelmRepositoryFragment "json:\"upsertHelmRepository,omitempty\" graphql:\"upsertHelmRepository\""}
...
return t.UpsertHelmRepository
	...
	type  IngestClusterCost struct{IngestClusterCost *bool "json:\"ingestClusterCost,omitempty\" graphql:\"ingestClusterCost\""}
...
return t.IngestClusterCost
	...
	type  ListNamespaces struct{ManagedNamespaces *ListNamespaces_ManagedNamespaces "json:\"managedNamespaces,omitempty\" graphql:\"managedNamespaces\""}
...
return t.ManagedNamespaces
	...
	type  ListClusterNamespaces struct{ClusterManagedNamespaces *ListClusterNamespaces_ClusterManagedNamespaces "json:\"clusterManagedNamespaces,omitempty\" graphql:\"clusterManagedNamespaces\""}
...
return t.ClusterManagedNamespaces
	...
	type  GetNamespace struct{ManagedNamespace *ManagedNamespaceFragment "json:\"managedNamespace,omitempty\" graphql:\"managedNamespace\""}
...
return t.ManagedNamespace
	...
	type  GetNamespaceByName struct{ManagedNamespace *ManagedNamespaceFragment "json:\"managedNamespace,omitempty\" graphql:\"managedNamespace\""}
...
return t.ManagedNamespace
	...
	type  CreateNamespace struct{CreateManagedNamespace *ManagedNamespaceFragment "json:\"createManagedNamespace,omitempty\" graphql:\"createManagedNamespace\""}
...
return t.CreateManagedNamespace
	...
	type  UpdateNamespace struct{UpdateManagedNamespace *ManagedNamespaceFragment "json:\"updateManagedNamespace,omitempty\" graphql:\"updateManagedNamespace\""}
...
return t.UpdateManagedNamespace
	...
	type  DeleteNamespace struct{DeleteManagedNamespace *DeleteNamespace_DeleteManagedNamespace "json:\"deleteManagedNamespace,omitempty\" graphql:\"deleteManagedNamespace\""}
...
return t.DeleteManagedNamespace
	...
	type  UpsertNotificationSink struct{UpsertNotificationSink *NotificationSinkFragment "json:\"upsertNotificationSink,omitempty\" graphql:\"upsertNotificationSink\""}
...
return t.UpsertNotificationSink
	...
	type  DeleteNotificationSink struct{DeleteNotificationSink *NotificationSinkFragment "json:\"deleteNotificationSink,omitempty\" graphql:\"deleteNotificationSink\""}
...
return t.DeleteNotificationSink
	...
	type  GetNotificationSink struct{NotificationSink *NotificationSinkFragment "json:\"notificationSink,omitempty\" graphql:\"notificationSink\""}
...
return t.NotificationSink
	...
	type  GetNotificationSinkByName struct{NotificationSink *NotificationSinkFragment "json:\"notificationSink,omitempty\" graphql:\"notificationSink\""}
...
return t.NotificationSink
	...
	type  ListNotificationSinks struct{NotificationSinks *ListNotificationSinks_NotificationSinks "json:\"notificationSinks,omitempty\" graphql:\"notificationSinks\""}
...
return t.NotificationSinks
	...
	type  GetNotificationRouter struct{NotificationRouter *NotificationRouterFragment "json:\"notificationRouter,omitempty\" graphql:\"notificationRouter\""}
...
return t.NotificationRouter
	...
	type  GetNotificationRouterByName struct{NotificationRouter *NotificationRouterFragment "json:\"notificationRouter,omitempty\" graphql:\"notificationRouter\""}
...
return t.NotificationRouter
	...
	type  DeleteNotificationRouter struct{DeleteNotificationRouter *NotificationRouterFragment "json:\"deleteNotificationRouter,omitempty\" graphql:\"deleteNotificationRouter\""}
...
return t.DeleteNotificationRouter
	...
	type  UpsertNotificationRouter struct{UpsertNotificationRouter *NotificationRouterFragment "json:\"upsertNotificationRouter,omitempty\" graphql:\"upsertNotificationRouter\""}
...
return t.UpsertNotificationRouter
	...
	type  CreateOIDCProvider struct{CreateOidcProvider *OIDCProviderFragment "json:\"createOidcProvider,omitempty\" graphql:\"createOidcProvider\""}
...
return t.CreateOidcProvider
	...
	type  UpdateOIDCProvider struct{UpdateOidcProvider *OIDCProviderFragment "json:\"updateOidcProvider,omitempty\" graphql:\"updateOidcProvider\""}
...
return t.UpdateOidcProvider
	...
	type  DeleteOIDCProvider struct{DeleteOidcProvider *OIDCProviderFragment "json:\"deleteOidcProvider,omitempty\" graphql:\"deleteOidcProvider\""}
...
return t.DeleteOidcProvider
	...
	type  ListObservabilityProviders struct{ObservabilityProviders *ListObservabilityProviders_ObservabilityProviders "json:\"observabilityProviders,omitempty\" graphql:\"observabilityProviders\""}
...
return t.ObservabilityProviders
	...
	type  GetObservabilityProvider struct{ObservabilityProvider *ObservabilityProviderFragment "json:\"observabilityProvider,omitempty\" graphql:\"observabilityProvider\""}
...
return t.ObservabilityProvider
	...
	type  UpsertObservabilityProvider struct{UpsertObservabilityProvider *ObservabilityProviderFragment "json:\"upsertObservabilityProvider,omitempty\" graphql:\"upsertObservabilityProvider\""}
...
return t.UpsertObservabilityProvider
	...
	type  DeleteObservabilityProvider struct{DeleteObservabilityProvider *ObservabilityProviderFragment "json:\"deleteObservabilityProvider,omitempty\" graphql:\"deleteObservabilityProvider\""}
...
return t.UpsertObserver
	...
	type  DeleteObserver struct{DeleteObserver *ObserverFragment "json:\"deleteObserver,omitempty\" graphql:\"deleteObserver\""}
...
return t.DeleteObserver
	...
	type  GetObserver struct{Observer *ObserverFragment "json:\"observer,omitempty\" graphql:\"observer\""}
...
return t.Observer
	...
	type  UpsertPolicyConstraints struct{UpsertPolicyConstraints *int64 "json:\"upsertPolicyConstraints,omitempty\" graphql:\"upsertPolicyConstraints\""}
...
return t.UpsertPolicyConstraints
	...
	type  ListPolicyConstraints struct{PolicyConstraints *PolicyConstraintConnectionFragment "json:\"policyConstraints,omitempty\" graphql:\"policyConstraints\""}
...
return t.PolicyConstraints
	...
	type  ListViolationStatistics struct{ViolationStatistics []*ViolationStatisticFragment "json:\"violationStatistics,omitempty\" graphql:\"violationStatistics\""}
...
return t.ViolationStatistics
	...
	type  SavePipeline struct{SavePipeline *PipelineFragmentMinimal "json:\"savePipeline,omitempty\" graphql:\"savePipeline\""}
...
return t.SavePipeline
	...
	type  DeletePipeline struct{DeletePipeline *PipelineFragmentID "json:\"deletePipeline,omitempty\" graphql:\"deletePipeline\""}
...
return t.Pipeline
	...
	type  GetPipelines struct{Pipelines *GetPipelines_Pipelines "json:\"pipelines,omitempty\" graphql:\"pipelines\""}
...
return t.Pipelines
	...
	type  CreatePipelineContext struct{CreatePipelineContext *PipelineContextFragment "json:\"createPipelineContext,omitempty\" graphql:\"createPipelineContext\""}
...
return t.CreatePipelineContext
	...
	type  GetPipelineContext struct{PipelineContext *PipelineContextFragment "json:\"pipelineContext,omitempty\" graphql:\"pipelineContext\""}
...
return t.PipelineContext
	...
	type  ListProjects struct{Projects *ListProjects_Projects "json:\"projects,omitempty\" graphql:\"projects\""}
...
return t.Projects
	...
	type  GetProject struct{Project *ProjectFragment "json:\"project,omitempty\" graphql:\"project\""}
...
return t.Project
	...
	type  CreateProject struct{CreateProject *ProjectFragment "json:\"createProject,omitempty\" graphql:\"createProject\""}
...
return t.CreateProject
	...
	type  UpdateProject struct{UpdateProject *ProjectFragment "json:\"updateProject,omitempty\" graphql:\"updateProject\""}
...
return t.UpdateProject
	...
	type  DeleteProject struct{DeleteProject *ProjectFragment "json:\"deleteProject,omitempty\" graphql:\"deleteProject\""}
...
return t.DeleteProject
	...
	type  CreateProviderCredential struct{CreateProviderCredential *ProviderCredentialFragment "json:\"createProviderCredential,omitempty\" graphql:\"createProviderCredential\""}
...
return t.CreateProviderCredential
	...
	type  DeleteProviderCredential struct{DeleteProviderCredential *ProviderCredentialFragment "json:\"deleteProviderCredential,omitempty\" graphql:\"deleteProviderCredential\""}
...
return t.DeleteProviderCredential
	...
	type  ListProviders struct{ClusterProviders *ListProviders_ClusterProviders "json:\"clusterProviders,omitempty\" graphql:\"clusterProviders\""}
...
return t.ClusterProviders
	...
	type  UpdateRbac struct{UpdateRbac *bool "json:\"updateRbac,omitempty\" graphql:\"updateRbac\""}
...
return t.UpdateRbac
	...
	type  ServiceAccounts struct{ServiceAccounts *ServiceAccounts_ServiceAccounts "json:\"serviceAccounts,omitempty\" graphql:\"serviceAccounts\""}
...
return t.ServiceAccounts
	...
	type  CreateServiceAccount struct{CreateServiceAccount *UserFragment "json:\"createServiceAccount,omitempty\" graphql:\"createServiceAccount\""}
...
return t.CreateServiceAccount
	...
	type  UpdateServiceAccount struct{UpdateServiceAccount *UserFragment "json:\"updateServiceAccount,omitempty\" graphql:\"updateServiceAccount\""}
...
return t.UpdateServiceAccount
	...
	type  CreateServiceAccountToken struct{CreateServiceAccountToken *AccessTokenFragment "json:\"createServiceAccountToken,omitempty\" graphql:\"createServiceAccountToken\""}
...
return t.CreateServiceAccountToken
	...
	type  ShareSecret struct{ShareSecret *ShareSecret_ShareSecret "json:\"shareSecret,omitempty\" graphql:\"shareSecret\""}
...
return t.ShareSecret
	...
	type  ListClusterStacks struct{ClusterStackRuns *ListClusterStacks_ClusterStackRuns "json:\"clusterStackRuns,omitempty\" graphql:\"clusterStackRuns\""}
...
return t.ClusterStackRuns
	...
	type  ListClusterStackIds struct{ClusterStackRuns *ListClusterStackIds_ClusterStackRuns "json:\"clusterStackRuns,omitempty\" graphql:\"clusterStackRuns\""}
...
return t.ClusterStackRuns
	...
	type  ListInfrastructureStacks struct{InfrastructureStacks *ListInfrastructureStacks_InfrastructureStacks "json:\"infrastructureStacks,omitempty\" graphql:\"infrastructureStacks\""}
...
return t.InfrastructureStacks
	...
	type  GetStackRunMinimal struct{StackRun *StackRunMinimalFragment "json:\"stackRun,omitempty\" graphql:\"stackRun\""}
...
return t.StackRun
	...
	type  GetStackRun struct{StackRun *StackRunFragment "json:\"stackRun,omitempty\" graphql:\"stackRun\""}
...
return t.StackRun
	...
	type  GetStackRunBase struct{StackRun *StackRunBaseFragment "json:\"stackRun,omitempty\" graphql:\"stackRun\""}
...
return t.StackRun
	...
	type  UpdateStackRun struct{UpdateStackRun *StackRunBaseFragment "json:\"updateStackRun,omitempty\" graphql:\"updateStackRun\""}
...
return t.UpdateStackRun
	...
	type  ApproveStackRun struct{ApproveStackRun *StackRunIDFragment "json:\"approveStackRun,omitempty\" graphql:\"approveStackRun\""}
...
return t.ApproveStackRun
	...
	type  CreateStack struct{CreateStack *InfrastructureStackFragment "json:\"createStack,omitempty\" graphql:\"createStack\""}
...
return t.CreateStack
	...
	type  UpdateStack struct{UpdateStack *InfrastructureStackFragment "json:\"updateStack,omitempty\" graphql:\"updateStack\""}
...
return t.UpdateStack
	...
	type  DetachStack struct{DetachStack *InfrastructureStackIDFragment "json:\"detachStack,omitempty\" graphql:\"detachStack\""}
...
return t.DetachStack
	...
	type  DeleteStack struct{DeleteStack *InfrastructureStackIDFragment "json:\"deleteStack,omitempty\" graphql:\"deleteStack\""}
...
return t.DeleteStack
	...
	type  GetInfrastructureStack struct{InfrastructureStack *InfrastructureStackFragment "json:\"infrastructureStack,omitempty\" graphql:\"infrastructureStack\""}
...
return t.InfrastructureStack
	...
	type  GetInfrastructureStackID struct{InfrastructureStack *InfrastructureStackIDFragment "json:\"infrastructureStack,omitempty\" graphql:\"infrastructureStack\""}
...
return t.InfrastructureStack
	...
	type  GetInfrastructureStackStatus struct{InfrastructureStack *InfrastructureStackStatusFragment "json:\"infrastructureStack,omitempty\" graphql:\"infrastructureStack\""}
...
return t.InfrastructureStack
	...
	type  CompletesStackRun struct{CompleteStackRun *StackRunIDFragment "json:\"completeStackRun,omitempty\" graphql:\"completeStackRun\""}
...
return t.CompleteStackRun
	...
	type  AddStackRunLogs struct{AddRunLogs *AddStackRunLogs_AddRunLogs "json:\"addRunLogs,omitempty\" graphql:\"addRunLogs\""}
...
return t.AddRunLogs
	...
	type  UpdateStackRunStep struct{UpdateRunStep *RunStepFragment "json:\"updateRunStep,omitempty\" graphql:\"updateRunStep\""}
...
return t.UpdateRunStep
	...
	type  UpdateCustomStackRun struct{UpdateCustomStackRun *CustomStackRunFragment "json:\"updateCustomStackRun,omitempty\" graphql:\"updateCustomStackRun\""}
...
return t.UpdateCustomStackRun
	...
	type  CreateCustomStackRun struct{CreateCustomStackRun *CustomStackRunFragment "json:\"createCustomStackRun,omitempty\" graphql:\"createCustomStackRun\""}
...
return t.CreateCustomStackRun
	...
	type  DeleteCustomStackRun struct{DeleteCustomStackRun *CustomStackRunFragment "json:\"deleteCustomStackRun,omitempty\" graphql:\"deleteCustomStackRun\""}
...
return t.DeleteCustomStackRun
	...
	type  GetCustomStackRun struct{CustomStackRun *CustomStackRunFragment "json:\"customStackRun,omitempty\" graphql:\"customStackRun\""}
...
return t.CustomStackRun
	...
	type  ListStackRuns struct{InfrastructureStack *ListStackRuns_InfrastructureStack "json:\"infrastructureStack,omitempty\" graphql:\"infrastructureStack\""}
...
return t.InfrastructureStack
	...
	type  TriggerRun struct{TriggerRun *StackRunBaseFragment "json:\"triggerRun,omitempty\" graphql:\"triggerRun\""}
...
return t.TriggerRun
	...
	type  GetStackDefinition struct{StackDefinition *StackDefinitionFragment "json:\"stackDefinition,omitempty\" graphql:\"stackDefinition\""}
...
return t.StackDefinition
	...
	type  ListStackDefinitions struct{StackDefinitions *ListStackDefinitions_StackDefinitions "json:\"stackDefinitions,omitempty\" graphql:\"stackDefinitions\""}
...
return t.StackDefinitions
	...
	type  CreateStackDefinition struct{CreateStackDefinition *StackDefinitionFragment "json:\"createStackDefinition,omitempty\" graphql:\"createStackDefinition\""}
...
return t.UpdateStackDefinition
	...
	type  DeleteStackDefinition struct{DeleteStackDefinition *StackDefinitionFragment "json:\"deleteStackDefinition,omitempty\" graphql:\"deleteStackDefinition\""}
...
return t.DeleteStackDefinition
	...
	type  ListAccessTokens struct{AccessTokens *ListAccessTokens_AccessTokens "json:\"accessTokens,omitempty\" graphql:\"accessTokens\""}
...
return t.AccessTokens
	...
	type  GetAccessToken struct{AccessToken *AccessTokenFragment "json:\"accessToken,omitempty\" graphql:\"accessToken\""}
...
return t.AccessToken
	...
	type  TokenExchange struct{TokenExchange *TokenExchange_TokenExchange "json:\"tokenExchange,omitempty\" graphql:\"tokenExchange\""}
...
return t.TokenExchange
	...
	type  CreateAccessToken struct{CreateAccessToken *AccessTokenFragment "json:\"createAccessToken,omitempty\" graphql:\"createAccessToken\""}
...
return t.CreateAccessToken
	...
	type  DeleteAccessToken struct{DeleteAccessToken *AccessTokenFragment "json:\"deleteAccessToken,omitempty\" graphql:\"deleteAccessToken\""}
...
return t.DeleteAccessToken
	...
	type  SaveUpgradeInsights struct{SaveUpgradeInsights []*SaveUpgradeInsights_SaveUpgradeInsights "json:\"saveUpgradeInsights,omitempty\" graphql:\"saveUpgradeInsights\""}
...
return t.SaveUpgradeInsights
	...
	type  GetUser struct{User *UserFragment "json:\"user,omitempty\" graphql:\"user\""}
...
return t.User
	...
	type  CreateUser struct{CreateUser *UserFragment "json:\"createUser,omitempty\" graphql:\"createUser\""}
...
return t.CreateUser
	...
	type  UpdateUser struct{UpdateUser *UserFragment "json:\"updateUser,omitempty\" graphql:\"updateUser\""}
...
return t.UpdateUser
	...
	type  DeleteUser struct{DeleteUser *UserFragment "json:\"deleteUser,omitempty\" graphql:\"deleteUser\""}
...
return t.DeleteUser
	...
	type  AddGroupMember struct{CreateGroupMember *GroupMemberFragment "json:\"createGroupMember,omitempty\" graphql:\"createGroupMember\""}
...
return t.CreateGroupMember
	...
	type  DeleteGroupMember struct{DeleteGroupMember *GroupMemberFragment "json:\"deleteGroupMember,omitempty\" graphql:\"deleteGroupMember\""}
...
return t.DeleteGroupMember
	...
	type  UpsertVulnerabilities struct{UpsertVulnerabilities *int64 "json:\"upsertVulnerabilities,omitempty\" graphql:\"upsertVulnerabilities\""}
