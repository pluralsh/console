...
func (in StatefulSetCell) GetProperty(name dataselect.PropertyName) dataselect.ComparableValue {
	switch name {
...
func (in StatefulSetCell) GetResourceSelector() *metricapi.ResourceSelector {
