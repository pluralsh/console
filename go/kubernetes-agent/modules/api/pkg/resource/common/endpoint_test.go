...
func TestGetInternalEndpoint(t *testing.T) {
	cases := []struct {
		...
		{"my-service", api.NamespaceDefault, nil, Endpoint{Host: "my-service", Ports: []ServicePort{}}},
		...
		{"my-service", "my-namespace", nil, Endpoint{Host: "my-service.my-namespace", Ports: []ServicePort{}}},
	...
	for _, c := range cases {
		...
		require.Equal(t, c.expected, actual, "serviceName=%s, namespace=%s, ports=%v",
			c.serviceName, c.namespace, c.ports)
	}
}
...
func TestGetExternalEndpoint(t *testing.T) {
	cases := []struct {
		...
		{api.LoadBalancerIngress{IP: "127.0.0.1"}, nil, Endpoint{Host: "127.0.0.1", Ports: []ServicePort{}}},
		{api.LoadBalancerIngress{IP: "127.0.0.1", Hostname: "host"}, nil, Endpoint{Host: "host", Ports: []ServicePort{}}},
