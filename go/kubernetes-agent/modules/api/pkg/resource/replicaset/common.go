...
func (in ReplicaSetCell) GetProperty(name dataselect.PropertyName) dataselect.ComparableValue {
	switch name {
...
func (in ReplicaSetCell) GetResourceSelector() *metricapi.ResourceSelector {
