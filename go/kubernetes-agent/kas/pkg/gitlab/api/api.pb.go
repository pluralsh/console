...
const file_pkg_gitlab_api_api_proto_rawDesc = "" +
	"\n" +
	"\x18pkg/gitlab/api/api.proto\x12\x17plural.agent.gitlab.api\x1a\x1bpkg/agentcfg/agentcfg.proto\x1a\x17validate/validate.proto\"\x80\x01\n" +
	"\rConfiguration\x12,\n" +
	...
	"\x0econfig_project\x18\x02 \x01(\v2&.plural.agent.gitlab.api.ConfigProjectB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0econfig_project\x12L\n" +
	"\rconfiguration\x18\x03 \x01(\v2&.plural.agent.gitlab.api.ConfigurationR\rconfiguration\"\x1f\n" +
	...
	"\x06groups\x18\x02 \x03(\v2\x1e.plural.agent.gitlab.api.GroupR\x06groups\"\x17\n" +
	"\x05Group\x12\x0e\n" +
	...
	"\busername\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01R\busername\"G\n" +
	...
	"\x0eallowed_agents\x18\x01 \x03(\v2%.plural.agent.gitlab.api.AllowedAgentR\x0eallowed_agents\x128\n" +
	"\x03job\x18\x02 \x01(\v2\x1c.plural.agent.gitlab.api.JobB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x03job\x12G\n" +
	"\bpipeline\x18\x03 \x01(\v2!.plural.agent.gitlab.api.PipelineB\b\xfaB\x05\x8a\x01\x02\x10\x01R\bpipeline\x12D\n" +
	"\aproject\x18\x04 \x01(\v2 .plural.agent.gitlab.api.ProjectB\b\xfaB\x05\x8a\x01\x02\x10\x01R\aproject\x12;\n" +
	"\x04user\x18\x05 \x01(\v2\x1d.plural.agent.gitlab.api.UserB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\x12F\n" +
	"\venvironment\x18\x06 \x01(\v2$.plural.agent.gitlab.api.EnvironmentR\venvironment\"\xd9\x01\n" +
	...
	"\x05agent\x18\x01 \x01(\v2/.plural.agent.gitlab.api.AuthorizedAgentForUserB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05agent\x12;\n" +
	"\x04user\x18\x02 \x01(\v2\x1d.plural.agent.gitlab.api.UserB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\x12[\n" +
	"\taccess_as\x18\x03 \x01(\v23.plural.agent.gitlab.api.AccessAsProxyAuthorizationB\b\xfaB\x05\x8a\x01\x02\x10\x01R\taccess_as\"\x82\x01\n" +
	"\x16AuthorizedAgentForUser\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12X\n" +
	"\x0econfig_project\x18\x02 \x01(\v2&.plural.agent.gitlab.api.ConfigProjectB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0econfig_project\"\xd9\x01\n" +
	"\x1aAccessAsProxyAuthorization\x12U\n" +
	"\x05agent\x18\x01 \x01(\v23.plural.agent.gitlab.api.AccessAsAgentAuthorizationB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\x05agent\x12R\n" +
	"\x04user\x18\x02 \x01(\v22.plural.agent.gitlab.api.AccessAsUserAuthorizationB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\x04userB\x10\n" +
	"\taccess_as\x12\x03\xf8B\x01\"\x1c\n" +
	"\x1aAccessAsAgentAuthorization\"\xa1\x01\n" +
	"\x19AccessAsUserAuthorization\x12D\n" +
	"\bprojects\x18\x01 \x03(\v2(.plural.agent.gitlab.api.ProjectAccessCFR\bprojects\x12>\n" +
	"\x06groups\x18\x02 \x03(\v2&.plural.agent.gitlab.api.GroupAccessCFR\x06groups\"7\n" +
	"\x0fProjectAccessCF\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05roles\x18\x02 \x03(\tR\x05roles\"5\n" +
	"\rGroupAccessCF\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05roles\x18\x02 \x03(\tR\x05roles\"\x98\x01\n" +
	"\x19AgentConfigurationRequest\x12#\n" +
	"\bagent_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\bagent_id\x12V\n" +
	"\fagent_config\x18\x02 \x01(\v2(.plural.agent.agentcfg.ConfigurationFileB\b\xfaB\x05\x8a\x01\x02\x10\x01R\fagent_configB@Z>github.com/pluralsh/console/go/kubernetes-agent/pkg/gitlab/apib\x06proto3"

var (
	file_pkg_gitlab_api_api_proto_rawDescOnce sync.Once
	file_pkg_gitlab_api_api_proto_rawDescData []byte
)

func file_pkg_gitlab_api_api_proto_rawDescGZIP() []byte {
	file_pkg_gitlab_api_api_proto_rawDescOnce.Do(func() {
		file_pkg_gitlab_api_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_gitlab_api_api_proto_rawDesc), len(file_pkg_gitlab_api_api_proto_rawDesc)))
	})
	return file_pkg_gitlab_api_api_proto_rawDescData
}

var file_pkg_gitlab_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_pkg_gitlab_api_api_proto_goTypes = []any{
...
func file_pkg_gitlab_api_api_proto_init() {
	...
	file_pkg_gitlab_api_api_proto_msgTypes[15].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_gitlab_api_api_proto_rawDesc), len(file_pkg_gitlab_api_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   0,
