...
//go:generate mockgen.sh -destination "tunnel.go" -package "mock_reverse_tunnel_tunnel" "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/reverse_tunnel/tunnel" "Tracker,Handler,FindHandle,Tunnel,PollingQuerier,Finder"
