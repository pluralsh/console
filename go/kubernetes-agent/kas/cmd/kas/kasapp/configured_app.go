...
import (
	...
	usage_metrics_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/usage_metrics/server"

	"github.com/pluralsh/console/go/kubernetes-agent/cmd/kas/kasapp/plural"
	"github.com/pluralsh/console/go/kubernetes-agent/pkg/api"
	gapi "github.com/pluralsh/console/go/kubernetes-agent/pkg/gitlab/api"
	agent_registrar_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/agent_registrar/server"
	"github.com/pluralsh/console/go/kubernetes-agent/pkg/module/agent_tracker"
	agent_tracker_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/agent_tracker/server"
	kubernetes_api_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/kubernetes_api/server"
	...
	observability_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/observability/server"
	reverse_tunnel_server "github.com/pluralsh/console/go/kubernetes-agent/pkg/module/reverse_tunnel/server"
