...
import (
	...
	"github.com/pluralsh/console/go/kubernetes-agent/api/pkg/resource/endpoint"
...
func TestGetServiceList(t *testing.T) {
				...
				Services: []Service{
					{
						...
						InternalEndpoint:  common.Endpoint{Host: "svc-1.ns-1", Ports: []common.ServicePort{}},
	...
	for _, c := range cases {
		fakeClient := fake.NewClientset(c.serviceList)
	...
	}{
		{
			...
			expected: ServiceDetail{
				Service: Service{
					TypeMeta:          types.TypeMeta{Kind: types.ResourceKindService},
					ExternalEndpoints: []common.Endpoint{},
					InternalEndpoint:  common.Endpoint{Ports: []common.ServicePort{}},
				},
			},
		}, {
			service: &v1.Service{
			...
			expected: ServiceDetail{
				Service: Service{
					...
					TypeMeta:          types.TypeMeta{Kind: types.ResourceKindService},
					InternalEndpoint:  common.Endpoint{Host: "test-service.test-namespace", Ports: []common.ServicePort{}},
					ExternalEndpoints: []common.Endpoint{},
				},
			},
		},
