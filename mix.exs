defmodule Console.MixProject do
  ...
  defp deps do
    [
      ...
      {:slack_elixir, git: "https://github.com/pluralsh/slack_elixir.git", ref: "56a2354f8936392a9f069d2bf271665dde9ec9c7"},
      ...
      {:mdex, "~> 0.1"},
      {:sentry, "~> 10.2.0"},
      {:absinthe_graphql_ws, git: "https://github.com/pluralsh/absinthe_graphql_ws.git", override: true},
      {:prom_ex, "~> 1.11.0"},
